 ...
 */
public class AssignPointsClozeFormula extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsClozeFormula() {
        //Adding the points to ClozeFormula question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 7503;
            ...
            addClozeFormulaQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsClozeFormula' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 2, enabled = true)
    public void pointAssignedToParticularQuestionClozeFormula() {
        try {
            String appendChar = "a11";
            String appendChar1 = "b41";
            int dataIndex = 7639;
            ...
            new Assignment().selectOwner("7639","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionClozeFormula' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsClozeFormula(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsClozeFormula' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsClozeFormula(){
        try{String appendChar = "a";
            int dataIndex = 7834;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsClozeFormula' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForClozeFormula(){
        try{String appendChar = "a";
            int dataIndex = 7891;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForClozeFormula' in class 'AssignPoints'", e);
        }
    }


    public void addClozeFormulaQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addClozeFormulaQuestion' in class 'AssignPoints'", e);
