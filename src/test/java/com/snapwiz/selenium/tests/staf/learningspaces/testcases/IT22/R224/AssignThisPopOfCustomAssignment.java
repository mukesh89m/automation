...
import com.snapwiz.selenium.tests.staf.learningspaces.pagefactory.DiscussionWidget.DiscussionWidget;
 ...
 */
public class AssignThisPopOfCustomAssignment extends Driver{
    ...
    public void assignThisPopOfCustomAssignment()
    {
        try {
          ...
          newAssignment.createAssignmentPolicy.click(); //click on the create assignment policy text
            ...
            Assert.fail("Exception in testcase assignThisPopOfCustomAssignment of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopOfUsePreCreatedAssignment()
    {
        try {
            ...
            Assert.fail("Exception in testcase assignThisPopOfUsePreCreatedAssignment of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopOfFileBasedAssignment()
    {
        try {
            ...
            Assert.fail("Exception in testcase assignThisPopOfFileBasedAssignment of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopOfStaticAssessment() {
        try {
            ...
            Assert.fail("Exception in testcase assignThisPopOfStaticAssessment of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopOfDiscussionWidget()
    {
        try {
            //Tc row no 53
            NewAssignment newAssignment = PageFactory.initElements(driver, NewAssignment.class);
            DiscussionWidget discussionWidget = PageFactory.initElements(driver,DiscussionWidget.class);
            ...
            Assert.fail("Exception in testcase assignThisPopOfDiscussionWidget of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopForAssignmentTab() {
        try {
            ...
            Assert.fail("Exception in testcase assignThisPopForAssignmentTab of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopForMyQuestionBank() {
        try {
            ...
            Assert.fail("Exception in testcase assignThisPopForMyQuestionBank of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopForEditThisFromMyQuestionBank() {
        try {
            ...
            Assert.fail("Exception in testcase assignThisPopForEditThisFromMyQuestionBank of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopForUpdateCustomAssignment() {
        try {
            ...
            //Tc row no 17
            System.out.println(newAssignment.assignmentReference_description5.getText());
            ...
            Assert.fail("Exception in testcase assignThisPopForUpdateCustomAssignment of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void assignThisPopForUpdateFileBasedAssignment() {
        try {
            ...
            Assert.fail("Exception in testcase assignThisPopForUpdateFileBasedAssignment of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void currentAssignmentForNonGradableAssignment() {
        try {
            ...
            Assert.fail("Exception in testcase currentAssignmentForNonGradableAssignment of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void currentAssignmentForGradableAssignment() {
        try {
            ...
            Assert.fail("Exception in testcase currentAssignmentForGradableAssignment of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void changedLabelGradingPolicyInMyResource() {
        try {
            ...
            Assert.fail("Exception in testcase changedLabelGradingPolicyInMyResource of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void changedLabelGradingPolicyInMyResourceForExistingInstructor() {
        try {
            ...
            Assert.fail("Exception in testcase changedLabelGradingPolicyInMyResourceForExistingInstructor of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void changedLabelGradingPolicyInAssignmentPage() {
        try {
            ...
            Assert.fail("Exception in testcase changedLabelGradingPolicyInAssignmentPage of class assignThisPopOfCustomAssignment", e);
        }
    }
    ...
    public void changedLabelNonGradingPolicyInAssignmentPage() {
        try {
            ...
            Assert.fail("Exception in testcase changedLabelNonGradingPolicyInAssignmentPage of class assignThisPopOfCustomAssignment", e);
        }
    }
