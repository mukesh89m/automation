 ...
 */
public class AssignPointsPassageBased extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsPassageBased() {
        //Adding the points to PassageBased question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 21;
            ...
            addPassageBasedQuestion(dataIndex);
            ...
            //TC row no. - 10 : Adding the points to PassageBased question explicitly
            ...
            Assert.fail("Exception in testcase 'addingPointsPassageBased' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionPassageBased() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("161","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionPassageBased' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsPassageBased(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsPassageBased' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 4,enabled = true)
    //Assigning the points
    public void gradedExplicitByTeacherNotToChangePointsPassageBased(){
        try{String appendChar = "a";
            int dataIndex = 356;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsPassageBased' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForPassageBased(){
        try{String appendChar = "a";
            int dataIndex = 414;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForPassageBased' in class 'AssignPoints'", e);
        }
    }


    public void addPassageBasedQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addPassageBasedQuestion' in class 'AssignPoints'", e);
        }
    }
}
