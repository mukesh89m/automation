...
public class TextSelectActions {
	...
	public void verifyHighlight(String paragraphId,String className,String index)
	{
		try
		{
			WebElement element = (new WebDriverWait(Driver.driver,10)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("p[class='nonindent']")));
	...
	public void addNote(String color,String paragraphId)
	{
		...
		//Sending Text
		noterandomstring = new com.snapwiz.selenium.tests.staf.dummies.apphelper.RandomString().randomstring(5);
	...
	public void addDiscussion(String color,String paragraphId,int moveToOffset,int moveByOffset)
	{
		...
		discussionstring = new com.snapwiz.selenium.tests.staf.dummies.apphelper.RandomString().randomstring(5);
