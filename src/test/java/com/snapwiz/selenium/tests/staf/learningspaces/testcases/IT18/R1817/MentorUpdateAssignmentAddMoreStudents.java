 ...
 */
public class MentorUpdateAssignmentAddMoreStudents extends Driver {
    
    @Test(priority = 1, enabled = true)
    public void mentorUpdateGradableAssignmentAddMoreStudents()
    {
        try
        {

            String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", "102");
            ...
            new LoginUsingLTI().ltiLogin("1021");		//login as student1
            new LoginUsingLTI().ltiLogin("1022");    //login as student2
            new LoginUsingLTI().ltiLogin("102");		//login a mentor
            new Assignment().assignToStudent(102);//assign to student1
            new Assignment().updateAssignment(1022, true);//assign to student2
            ...
            popUpFound = new BooleanValue().presenceOfElement(102, By.className("delete-notification"));
            ...
            classActivity = new BooleanValue().presenceOfElement(102, By.id("course-stream"));
            ...
            csEntry = new BooleanValue().presenceOfElement(102, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            ...
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            boolean csEntry1 = new BooleanValue().presenceOfElement(102, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
        ...
        {
            Assert.fail("Exception in class MentorUpdateAssignmentAddMoreStudents in method mentorUpdateGradableAssignmentAddMoreStudents.", e);
        }
    }

    @Test(priority = 2, enabled = true)
    public void mentorUpdateNonGradableAssignmentAddMoreStudents()
    {
        try
        {

            String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", "103");
            CurrentAssignments currentAssignments = PageFactory.initElements(driver, CurrentAssignments.class);
            Gradebook gradebook = PageFactory.initElements(driver, Gradebook.class);
            LessonPage lessonPage = PageFactory.initElements(driver, LessonPage.class);
            EngagementReport engagementReport = PageFactory.initElements(driver, EngagementReport.class);
            ...
            new LoginUsingLTI().ltiLogin("1031");		//login as student1
            new LoginUsingLTI().ltiLogin("1032");    //login as student2
            new LoginUsingLTI().ltiLogin("103");		//login a mentor
            new Assignment().assignToStudent(103);//assign to student1
            new Assignment().updateAssignment(1032, true);//assign to student2
            new Navigator().NavigateTo("Current Assignments");
            new UIElement().waitAndFindElement(currentAssignments.getUnAssignAssignment_button());
            ...
            //Expected: The pop-up message should disappear.//
            currentAssignments.getCloseForUnAssign_icon().click();//click on Close icon
            popUpFound = new BooleanValue().presenceOfElement(103, By.className("delete-notification"));
            Assert.assertEquals(popUpFound, false, "The pop-up message doesn't disappear after clicking on Close icon");
            ...
            //Expected: On Dashboard,the assignment entry should get removed from Course Stream tab
            new Navigator().NavigateTo("Dashboard");
            classActivity = new BooleanValue().presenceOfElement(103, By.id("course-stream"));
            Assert.assertEquals(classActivity, false, "On Dashboard,the assignment entry does not get removed from Course Stream tab.");
            //TC row no. 107
            //"8. Navigate to Course Stream Page from Main navigator"
            //Expected: The assignment entry should get removed  along with social elements from Course Stream Page
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            csEntry = new BooleanValue().presenceOfElement(103, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            Assert.assertEquals(csEntry, false, "On CS ,the assignment entry does not get removed from Course Stream tab.");
            //TC row no. 109
            //9. Navigate to Gradebook page
            //The entry for that assignment should be removed.//
            ...
            //Expected: The card which shows the mentor posted that assignment should be removed with its social elements.//
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            boolean csEntry1 = new BooleanValue().presenceOfElement(103, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            Assert.assertEquals(csEntry1, false, "On CS ,the assignment entry does not get removed from Course Stream tab of student side.");
        ...
        {
            Assert.fail("Exception in class MentorUpdateAssignmentAddMoreStudents in method mentorUpdateNonGradableAssignmentAddMoreStudents.", e);
        }
    }
