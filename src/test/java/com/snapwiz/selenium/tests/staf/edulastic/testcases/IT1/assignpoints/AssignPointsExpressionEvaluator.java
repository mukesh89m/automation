 ...
 */
public class AssignPointsExpressionEvaluator extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsExpressionEvaluator() {
        //Adding the points to ExpressionEvaluator question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 3025;
            ...
            addExpressionEvaluatorQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsExpressionEvaluator' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionExpressionEvaluator() {
        try {
            String appendChar = "a";
            ...
            new Login().loginAsInstructor(appendChar, dataIndex);//Login as a teacher
            new School().createWithOnlyName(appendChar, dataIndex);//create school
            new Classes().createClass(appendChar, dataIndex,"Grade 5","Mathematics","Math - Common Core");//create class
            ...
            new Classes().createClass(appendChar1, dataIndex,"Grade 5","Mathematics","Math - Common Core");//create class
            new Navigator().logout();//log out
            ...
            new Assignment().selectOwner("3162","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionExpressionEvaluator' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsExpressionEvaluator(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsExpressionEvaluator' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsExpressionEvaluator(){
        try{String appendChar = "a";
            int dataIndex = 3357;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsExpressionEvaluator' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForExpressionEvaluator(){
        try{String appendChar = "a";
            int dataIndex = 3415;
            ...
            addExpressionEvaluatorQuestion(3416);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("4");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            trueFalse.getButton_review().click();//Click on review button
            listPage.getButton_addMore().click();//Click on add more button
            addExpressionEvaluatorQuestion(3417);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("5");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForExpressionEvaluator' in class 'AssignPoints'", e);
        }
    }



    public void addExpressionEvaluatorQuestion(int index) {
