...
public class Assignments {
    ...
    public WebElement goToNextLinkOnPopUp;// go to next question link on pop-up
    ...
    @FindBy(xpath = "//div[@class='al-notification-message-header']//div[2]")
    ...
    @FindBy(className = "ls-graded-count")
    public WebElement gradedCount;

    @FindBy(id = "ls-overall-score-btn")
    public WebElement overAllScore;

    @FindBy(css = "a[class='btn btn--primary btn--large btn--submit long-text-button adaptive-assignment-finish-button']")
    public WebElement adaptiveFinish_button;

    @FindBy(css = "div[class='adaptive-assignment-notification-option option-i-am-finished']>span")
    public WebElement iamFinished_link;

    @FindBy(css = "div[class='adaptive-assignment-notification-option option-keep-open']>span")
    public WebElement assignmentOpenTillDueDate_link;

    @FindBy(css = "span[class='ls-assignment-bookmark not-bookmarked']")
    public List<WebElement> bookMarkAssignment;

    @FindBy(css = "span[class='ls-assignment-bookmark bookmarked']")
    public List<WebElement> unBookMarkAssignment;

    @FindBy(xpath = "//div[@class='ls-completed-content']/div")
    public List<WebElement> completed_count; //student side completed count status

    @FindBy(xpath = "//a[@title='All Assignments']")
    public WebElement AllAssignmentsFilter;

    @FindBy(className = "ls-assignment-performance-graph")
    public List<WebElement> assignmentPerformanceGraph;

    @FindBy(xpath = "//div[starts-with(@class,'social-policy-configuration-wrapper-tooltip')]")
    public WebElement socialPolicyConfigurationWrapper_tooltip;

    @FindBy(className = "no-data-notification-message-block-assignments")
    public WebElement noAssignmentEntry;

    @FindBy(css = "div[class='duedate-notification']>span")
    public WebElement dueDateNotification;

    @FindBy(id = "uploadFileRes")
    public WebElement link_uploadFile;

    @FindBy(className = "ins-uploadResource-input")
    public WebElement textField_assignmentReferenceName;

    @FindBy(className = "ins-uploadResource-textbox")
    public WebElement textField_assignmentDescription;

    @FindBy(css = "span[class='ins-dialogBox-Save ins-resource-save-btn']")
    public WebElement button_save;

    @FindBy(css = ".timed-assignment-notification-content>div")
    public List<WebElement> timeAssignmentNotification;

    @FindBy(className = "timed-assignment-notification-header")
    public WebElement timeAssignment_header;

    @FindBy(className = "timed-assignment-help-msg")
    public WebElement timeAssignmentHelp_msg;

    @FindBy(css = ".model-window-action-no")
    public WebElement timeAssignment_noLink;

    @FindBy(css = ".model-window-action-yes")
    public WebElement timeAssignment_yesLink;

    @FindBy(css = ".duedate-notification")
    public WebElement timeElapsed_message;

    @FindBy(css = "span[class='timevalue count-down-timer-warning']")
    public WebElement timer;

    @FindBy(className = "timed-assignment-notification-header")
    public WebElement timedAssignmentHeader;

    @FindBy(className = "close-modal-window")
    public WebElement closeIconOnPopUp;

    @FindBy(className = "modal-window-content")
    public WebElement popUpMessage;

    @FindBy(className = "timevalue")
    public WebElement time;

    @FindBy(className = "close-duedate-assignment")
    public  WebElement closeDueDate;

    @FindBy(css = ".close-duedate-assignment")
    public WebElement closeDueDate_button;

    @FindBy(css = "li[class='question-link-label s--check-enable not-attempted-question current-question-view']")
    public WebElement notAttemptedQuestion;

    @FindBy(xpath = "//div[@id='display-label']//strong")
    public WebElement question_index;

    @FindBy(css = "span[class='idb-gradebook-view-username assigned-time-limit']")
    public List<WebElement> assignedTimeLimit;

    @FindBy(css=".assignment-policy-name")
    public  WebElement policyName;

    @FindBy(css = "i[class='ls-not-applicable-icon']")
    public WebElement notApplicable_icon;

    @FindBy(className = "ls-assignment-performance-graph")
    public WebElement assignmentPerformanceGraphICon;

    @FindBy(className = "policy-dialog-header-text")
    public WebElement policyHeader;

    @FindBy(id = "ls-assignment-not-started-count")
