...
public class QuestionTypeAndCount {
    ...
    public void questionTypeCount(String query) throws Exception {
        List<String> questionType = new com.snapwiz.selenium.tests.staf.AppiumLearningspaces.uihelper.TextFetch().textfetchbylistclasswithoutindex("cms-QuestionsType-name");
        List<String> questionCounts = new com.snapwiz.selenium.tests.staf.AppiumLearningspaces.uihelper.TextFetch().textfetchbylistclasswithoutindex("cms-QuestionsTotal-count");
