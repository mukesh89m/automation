...
/*
 * Created by Dharaneesha on 5/13/15.
 */
public class AssigningMPQAssignmentAsMentor extends Driver{
    String actual = null;
    ...
    public void instructorToBeAbleToAssignMPQAssignment(){
        try{
            ...
            Assert.fail("Exception in the testcase 'instructorToBeAbleToAssignMPQAssignment' in the class 'AssigningMPQAssignmentAsMentor'", e);
        }
...
*/
            ...
            Assert.fail("Exception in the testcase 'instructorToBeAbleToProvideFeedbackForMPQGradableAssignment' in the class 'AssigningMPQAssignmentAsMentor'", e);
        }
...
*/
    ...
    public void studentTobeAbleToViewReportForMPQQuestions(){
        try{
            /*Row No - 31 : "1. Login as instructor of LS Course
            2. Go to Assignments->Question Banks page
            3. Click on Assign this icon and assign the static assessment having multipart as non-gradable assignment
            4. Login as student
            5. Submit the assignment
            ...
            new Assignment().create(dataIndex);
            new Assignment().addQuestions(32,"multipart",assessmentName);
            new Assignment().addQuestions(32,"truefalse",assessmentName);
            new Assignment().addQuestions(32,"truefalse",assessmentName);
            new Assignment().addQuestions(32,"truefalse",assessmentName);
            new Assignment().addQuestions(32,"truefalse",assessmentName);
            new Assignment().addQuestions(32,"truefalse",assessmentName);
            ...
            new LoginUsingLTI().ltiLogin("31_1");//Login as in instructor
            new Assignment().assignToStudent(dataIndex);
            new LoginUsingLTI().ltiLogin("31_2");//Login as a student
            new Assignment().submitAssignmentAsStudent(32);
            new LoginUsingLTI().ltiLogin("31_1");//Login as in instructor
            new Reports().navigateToPerformanceReportPage(31,3);

            //ClassSectionPerformaceJob
            //To be Continued
        }catch(Exception e){
            Assert.fail("Exception in the testcase 'instructorToBeAbleToProvideFeedbackForMPQGradableAssignment' in the class 'AssigningMPQAssignmentAsMentor'", e);
        }
    ...
    public void instructorTobeAbleToPreviewMPQAssignment(){
        try{
            ...
            Assert.fail("Exception in the testcase 'instructorTobeAbleToPreviewMPQAssignment' in the class 'AssigningMPQAssignmentAsMentor'", e);
        }
    ...
    public void instructorTobeAbleToReportContentIssues(){
        try{
            ...
            Thread.sleep(5000);
            String assessmentName = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(75));

            selectInvisiblebottomAssignment(assessmentName);
            ...
            selectInvisiblebottomAssignment(assessmentName);
            new Click().clickByElement(assignments.dialog_ContentIssue);
            new UIElement().waitAndFindElement(assignments.message_ReportContentIssue);
            Thread.sleep(2000);
            if(!(assignments.message_ReportContentIssue.getText().contains("There is some mistake in the question"))){
                Assert.fail("Instructor should be able to send report content error successfully");
            }
            ...
            String chapterNameToSearch = ReadTestData.readDataByTagName("", "chapterNameToSearch", Integer.toString(73));
            ...
            new WebDriverWait(driver,60).until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@title='"+assessmentName+"']")));
            List<WebElement>  elementList= driver.findElements(By.xpath(".//*[@title='"+assessmentName+"']"));
            ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", elementList.get(elementList.size()-1));
            ((JavascriptExecutor)driver).executeScript("arguments[0].click();",elementList.get(elementList.size()-1));
            Thread.sleep(5000);
    ...
    public ArrayList<String> traverseQuestionsPartsInMPQInResponsePage(int dataIndex){
        ...
        try{
            ...
            Assert.fail("Exception in the method 'traverseQuestionsPartsInMPQInResponsePage' in the class 'AssigningMPQAssignmentAsMentor'",e);
        }
        return questionList;
    }
