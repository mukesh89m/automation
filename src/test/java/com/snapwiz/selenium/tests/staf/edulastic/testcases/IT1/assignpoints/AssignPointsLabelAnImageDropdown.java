 ...
 */
public class AssignPointsLabelAnImageDropdown extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsLabelAnImageDropdown() {
        //Adding the points to labelAnImageDropdown question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 7006;
            ...
            new WebDriverWait(driver,20).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("div[class='as-assignment-flow-icon as-create-new-assignment-icon']")));
            createAssessment.getButton_create().click();//Click on create new assessment
            addLabelAnImageDropdownQuestion(dataIndex);
           ...
           new Assignment().submitPreviewQuestion();
            ...
            Assert.fail("Exception in testcase 'addingPointsLabelAnImageDropdown' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 2, enabled = true)
    public void pointAssignedToParticularQuestionLabelAnImageDropdown() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("7143","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionLabelAnImageDropdown' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsLabelAnImageDropdown(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsLabelAnImageDropdown' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsLabelAnImageDropdown(){
        try{String appendChar = "a";
            int dataIndex = 7338;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsLabelAnImageDropdown' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForLabelAnImageDropdown(){
        try{String appendChar = "a";
            int dataIndex = 7395;
            ...
            addLabelAnImageDropdownQuestion(7396);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("4");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            trueFalse.getButton_review().click();//Click on review button
            listPage.getButton_addMore().click();//Click on add more button
            addLabelAnImageDropdownQuestion(7397);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("5");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForLabelAnImageDropdown' in class 'AssignPoints'", e);
        }
    }


    public void addLabelAnImageDropdownQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addLabelAnImageDropdownQuestion' in class 'AssignPoints'", e);
