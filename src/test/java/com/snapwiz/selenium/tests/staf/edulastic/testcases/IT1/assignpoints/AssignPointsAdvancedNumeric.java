 ...
 */
public class AssignPointsAdvancedNumeric extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsAdvancedNumeric() {
        //Adding the points to AdvancedNumeric question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 2527;
            ...
            addAdvancedNumericQuestion(dataIndex);
           ...
           new Assignment().submitPreviewQuestion();
            ...
            Assert.fail("Exception in testcase 'addingPointsAdvancedNumeric' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionAdvancedNumeric() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("2664","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionAdvancedNumeric' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsAdvancedNumeric(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsAdvancedNumeric' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 4,enabled = true)
    //Assigning the points
    public void gradedExplicitByTeacherNotToChangePointsAdvancedNumeric(){
        try{String appendChar = "a";
            int dataIndex = 2857;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsAdvancedNumeric' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForAdvancedNumeric(){
        try{String appendChar = "a";
            int dataIndex = 2915;
            ...
            addAdvancedNumericQuestion(2916);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("4");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            trueFalse.getButton_review().click();//Click on review button
            listPage.getButton_addMore().click();//Click on add more button
            addAdvancedNumericQuestion(2917);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("5");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForAdvancedNumeric' in class 'AssignPoints'", e);
        }
    }

    public void addAdvancedNumericQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            new Click().clickByid("qtn-maple-numeric-type");//click on Numeric Entry with Units type question
            closeHelp();
            ...
            Assert.fail("Exception in testcase 'addAdvancedNumeric' in class 'AssignPoints'", e);
