...
public  class ReadTestData {
	private static Logger logger = Logger.getLogger("com.snapwiz.selenium.tests.staf.AppiumLearningspaces.ReadTestData");
	public static String [] readData(String className, String tcIndex) {
		...
		File fXmlFile = new File(workingDir+"/src/test/java/com/snapwiz/selenium/tests/staf/AppiumLearningspaces/testdata_"+classNameTrimmed+".xml");
	...
	public static String readDataByTagName(String className, String tagName, String tcIndex) {
		  String  testdata = null;
		    try
		    {
		    	...
		    	if(className.contains("com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelperAppium"))
                {
				...
				if(className.contains("com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelper.Assignment"))
				{
					System.out.println("4");
					className = new Exception().getStackTrace()[3].getClassName();
					classNametag = className;
					String className4 = new Exception().getStackTrace()[4].getClassName();
					String className3 = new Exception().getStackTrace()[3].getClassName();
					String className1 = new Exception().getStackTrace()[1].getClassName();
					String className2 = new Exception().getStackTrace()[2].getClassName();
					/*System.out.println("Stack1::"+className1);
					System.out.println("Stack2::"+className2);
					System.out.println("Stack3::"+className3);
					System.out.println("Stack4::"+className4);
					System.out.println(">>>>>>>>>>>>>>>>>");*/
				}
				if(className.contains("com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelper"))
				{
				...
				className = className.substring(63);
		        className = className.replaceAll("\\.", "_");
		    	String classNameTrimmed= "";
				int cnt = 0;
	    	for(int i=0;i<className.length();i++)
	    	{
		   	...
		   	String workingDir = System.getProperty("user.dir");
			File fXmlFile = new File(workingDir+"/src/test/java/com/snapwiz/selenium/tests/staf/AppiumLearningspaces/testdata/testdata_"+classNameTrimmed+".xml");
