...
public class Click extends Driver{
    ...
    public void clickByCSSSelectorsIfDisplayed(String cssSelector)
    {
        WebDriver driver=Driver.getWebDriver();
        try
        {
        ...
        {
            Assert.fail("Exception in apphelper clickByCSSSelectorsIfDisplayed in class Click",e);
        }
    }
