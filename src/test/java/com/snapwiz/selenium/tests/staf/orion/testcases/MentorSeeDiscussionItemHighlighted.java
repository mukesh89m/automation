...
public class MentorSeeDiscussionItemHighlighted 
{
	@Test
	public void mentorSeeDiscussionItemHighlighted()
	{
		try
		{
			Driver.startDriver();
			new LoginUsingLTI().ltiLogin("1046");//login as 1st mentor
			int count1=new InstructorDashboardMatrix().discussioncount();//fetch discussion value for 1st instructor
			new LoginUsingLTI().ltiLogin("10461");//login as 2nd mentor
			int count2=new InstructorDashboardMatrix().discussioncount();//fetch discussion value for 2nd instructor
			new LoginUsingLTI().ltiLogin("10462");//login as student
			...
			new LoginUsingLTI().ltiLogin("1046");//again login as 1st mentor
			...
			new LoginUsingLTI().ltiLogin("10461");//again login as 2nd mentor
