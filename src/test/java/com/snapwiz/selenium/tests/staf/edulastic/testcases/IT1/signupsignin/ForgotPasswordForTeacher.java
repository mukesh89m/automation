 ...
 */
public class ForgotPasswordForTeacher extends Driver {

    @Test(priority = 1,enabled = true)
    public void forgotPasswordForTeacher(){
        try{
            String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'forgotPasswordForTeacher' in class 'ForgotPasswordForTeacher'", e);
