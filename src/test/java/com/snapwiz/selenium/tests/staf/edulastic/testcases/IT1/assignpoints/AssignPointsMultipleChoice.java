 ...
 */
public class AssignPointsMultipleChoice extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsMultipleChoice() {
        //Adding the points to multiple choice question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 533;
            ...
            addMultipleChoiceQuestion(dataIndex);
    ...
    public void pointAssignedToParticularQuestionMultipleChoice() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("669","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionMultipleChoice' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsMultipleChoice(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsMultipleChoice' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsMultipleChoice(){
        try{String appendChar = "a";
            int dataIndex = 863;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsMultipleChoice' in class 'AssignPoints'", e);
        }
    }
    ...
    public void pointsVerifyMultipleQuestionForMultipleChoice(){
        try{String appendChar = "a";
            int dataIndex = 922;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForMultipleChoice' in class 'AssignPoints'", e);
        }
    }

    public void addMultipleChoiceQuestion(int index){
        try{
            ...
            Assert.fail("Exception in testcase 'addMultipleChoiceQuestion' in class 'AssignPoints'", e);
        }
    }
