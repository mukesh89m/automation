 ...
 */
public class CreateCustomAssignmentFromDifferentPlacesLS extends Driver {
    ...
    public void SearchFilterFromCAP() {
        ...
        try {
            ...
            new BrowseSearchFunctionalityMethod().clickOnTheFilerForSearch();
            new BrowseSearchFunctionalityMethod().filterWithCheckboxAndColorVerificationLS();
            goToCreateCustomAssignmentFromCAP();
            new BrowseSearchFunctionalityMethod().clickOnTheFilerForSearch();
            ...
            Assert.fail("Exception in TC SearchFilterFromCAP of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void BrowseFilterFromCAP() {
        ...
        try {
            ...
            Assert.fail("Exception in TC BrowseFilterFromCAP of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void SearchFilterFromCustomizedThis() {
        ...
        try {
            ...
            Assert.fail("Exception in TC SearchFilterFromCustomizedThis of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void browseFilterFromCustomizedThis() {
        ...
        try {
            ...
            Assert.fail("Exception in TC browseFilterFromCustomizedThis of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void searchFilterForSaveForLater(){
        ...
        try {
            ...
            Assert.fail("Exception in TC searchFilterForSaveForLater of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void browseFilterForEditThisLink(){
        ...
        try {
            ...
            Assert.fail("Exception in TC browseFilterForEditThisLink of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void searchFilterForUpdateAssignment(){
        ...
        try {
            ...
            Assert.fail("Exception in TC searchFilterForUpdateAssignment of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void browseFilterForUpdateAssignment(){
        ...
        try {
            ...
            Assert.fail("Exception in TC browseFilterForUpdateAssignment of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void searchFilterForShareWithOtherInstructor(){
        ...
        try {
            ...
            Assert.fail("Exception in TC searchFilterForShareWithOtherInstructor of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void toggleBetweenSearchAndBrowse(){
        ...
        try {
            ...
            Assert.fail("Exception in TC toggleBetweenSearchAndBrowse of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    @Test(priority = 10, enabled = true)
    public void cmsCreatedAdvancedQuestionFilterLink(){
        ...
        try {
            ...
            Assert.fail("Exception in TC cmsCreatedAdvancedQuestionFilterLink of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
    ...
    public void algoDataTypeFilterLink(){
        ...
        try {
            ...
            Assert.fail("Exception in TC algoDataTypeFilterLink of class CreateCustomAssignmentFromDifferentPlacesLS", e);
        }
    }
