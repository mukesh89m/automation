 ...
 */
public class InstructorAbleToUnAssignNonGradableAssignment extends Driver{

    @Test(priority = 1, enabled = true)
    public void instructorAbleToUnAssignNonGradableAssignment()
    {
        try
        {
            String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", "67");
            ...
            new LoginUsingLTI().ltiLogin("67_1");		//login as student1
            new LoginUsingLTI().ltiLogin("67_2");    //login as student2
            new LoginUsingLTI().ltiLogin("67");		//login a instructor
            new Assignment().assignToStudent(67);
            ...
            popUpFound = new BooleanValue().presenceOfElement(67, By.className("delete-notification"));
            ...
            classActivity = new BooleanValue().presenceOfElement(67, By.id("course-stream"));
            ...
            csEntry = new BooleanValue().presenceOfElement(67, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            ...
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            boolean csEntry1 = new BooleanValue().presenceOfElement(67, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
        ...
        {
            Assert.fail("Exception in class InstructorAbleToUnAssignNonGradableAssignment in method instructorAbleToUnAssignNonGradableAssignment.", e);
        }
    }
