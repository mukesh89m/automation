 ...
 */
public class BrowseFunctionalityOfQuestionBank extends Driver{
    ...
    public void browseFunctionalityOfQuestionBank() {
        ...
        try {
            ...
            Assert.fail("Exception in TC browseFunctionalityOfQuestionBank of class BrowseFunctionalityOfQuestionBank", e);
        }
    }
    ...
    public void browseFunctionalityOfQuestionBankForMentor() {
        ...
        try {
            ...
            Assert.fail("Exception in TC browseFunctionalityOfQuestionBankForMentor of class BrowseFunctionalityOfQuestionBank", e);
        }
    ...
    public void allQuestionTypeFilterForBrowse() {
        try {
           ...
           //TC row no 71
            ...
            Assert.fail("Exception in TC allQuestionTypeFilterForBrowse of class BrowseFunctionalityOfQuestionBank", e);
        }
    }
    ...
    public void allQuestionTypeFilterFunctionalityMentor() {
        try {
            ...
            Assert.fail("Exception in TC allQuestionTypeFilterFunctionalityMentor of class BrowseFunctionalityOfQuestionBank", e);
        }
    }
    ...
    public void newOrderQuestionInBrowser() {
        try {
            ...
            Assert.fail("Exception in TC newOrderQuestionInBrowser of class BrowseFunctionalityOfQuestionBank", e);
        }
    }
