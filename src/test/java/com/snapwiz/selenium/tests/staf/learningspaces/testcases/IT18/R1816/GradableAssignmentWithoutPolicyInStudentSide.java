 ...
 */
public class GradableAssignmentWithoutPolicyInStudentSide extends Driver {
    @Test(priority = 1, enabled = true)
    public void gradableAssignmentWithoutPolicyInStudentSide() {
        ...
        try {
            ...
            new LoginUsingLTI().ltiLogin("204_1");//login as student
            new LoginUsingLTI().ltiLogin("204"); //login as instructor
            new Assignment().create(204); //create assignment
            for(int i=0;i<11;i++)
                new Assignment().addQuestions(204,"truefalse","");
            new LoginUsingLTI().ltiLogin("204");//login as instructor
            new Assignment().assignToStudent(204); //assign to the student
            new LoginUsingLTI().ltiLogin("204_1"); //login as student
            new Assignment().submitAssignmentAsStudent(204); //submit assignment
           /* new LoginUsingLTI().ltiLogin("204");//login as instructor
            ...
            Thread.sleep(5000);
            System.out.println("Average Performance : " + avgPerformance);
            ...
            String performance2=performance.substring(0,index4-1);
            ...
            String dueDateMessage=assignments.getDueDateMessage().get(0).getText().trim();
            System.out.println("Due date message:"+dueDateMessage);
            assignments.getAssignmentName().click();//click on the assignment name
            new WebDriverWait(driver, 600).until(ExpectedConditions.presenceOfElementLocated(By.className("title-and-question-header")));
            ...
            System.out.println("Chapter Proficiency Summary Report Before Update Grade:"+chapProficiencySummary);

            String chapObjProficiency=proficiencyReport.getBarChart().getAttribute("height"); //teacherProficiencyReport
            System.out.println("Chapter Proficiency by Objectives Report By Objective Before Update Grade:"+chapObjProficiency);
            ...
            System.out.println("Objective Proficiency Summary Report Before Update Grade:"+objProficiencySummary);

           /* String objProficiencyByQuestion=proficiencyReport.getBarChart().getAttribute("height"); //teacherProficiencyReport
            System.out.println("Objective Proficiency by Questions Before Update Grade:"+objProficiencyByQuestion);
            ...
            System.out.println("Student proficiency-percentage: "+studMetaCogProfReport);
            ...
            System.out.println("Colored marker proficiency By chapter: "+colorMarkerProfByChapValue);
            ...
            System.out.println("Colored marker proficiency By Objective: "+colorMarkerProfByObjectiveValue);
            ...
            System.out.println("Student ProductivityCogProfReport: "+studProdCogProfReport);
            ...
            System.out.println(" Productivity Colored marker proficiency By chapter:"+prodColorMarkerProfByChapValue);
            ...
            System.out.println("Productivity Colored marker proficiency By Objective:"+prodColorMarkerProfByObjectiveValue);
            ...
            System.out.println("Most Challenging proficiency By chapter:"+mostProficiency);
            ...
            System.out.println("pass");
            System.out.println("Most Challenging performance By chapter:"+mostPerformance);
            ...
            System.out.println("Most Challenging proficiency By Objective:" + mostObjectiveProficiency);
            Thread.sleep(5000);
            ...
            System.out.println("pass");
            System.out.println("Most Challenging performance By Objective:"+mostObjectivePerformance);

            new LoginUsingLTI().ltiLogin("204");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(204); //provide grade to all question
            ...
            Thread.sleep(5000);
            System.out.println("Average Performance : " + avgPerformance1);
            ...
            String performance21=performance1.substring(0,index41-1);
            int avgQuestionPerformance1=Integer.parseInt(performance21);
            System.out.println("AvgQuestionPerformance :"+avgQuestionPerformance1);
            System.out.println("pass");

            new Navigator().NavigateTo("Assignments");//navigate to assignment
            //Expected 4 Student should be navigated to 'Assignment Summary' page
            Assert.assertEquals(driver.findElement(By.xpath("//span[@title='(shor)  Assignment_IT18_204']")).isDisplayed(), true, " Student is not navigated to 'Assignment Summary' page");
            String overallScore1=assignments.getOverallScorePercentage().getText().trim();
            System.out.println("OverAll Score:"+overallScore1);

            String dueDateMessage1=assignments.getDueDateMessage().get(1).getText().trim();
            System.out.println("Due date message:"+dueDateMessage1);
            assignments.getAssignmentName().click();//click on the assignment name
            Thread.sleep(5000);
            ...
            System.out.println("Course Proficiency Summary Report Before Update Grade:"+classProficiency1);
            String classProficiencyChap1=proficiencyReport.getBarChart().getAttribute("height"); //teacherProficiencyReport
            System.out.println("Course Proficiency By chapter Before Update Grade:"+classProficiencyChap1);
            ...
            System.out.println("Chapter Proficiency Summary Report Before Update Grade:"+chapProficiencySummary1);

            String chapObjProficiency1=proficiencyReport.getBarChart().getAttribute("height"); //teacherProficiencyReport
            System.out.println("Chapter Proficiency by Objectives Report By Objective Before Update Grade:"+chapObjProficiency1);
            ...
            System.out.println("Objective Proficiency Summary Report Before Update Grade:"+objProficiencySummary1);

            String objProficiencyByQuestion1=proficiencyReport.getBarChart().getAttribute("height"); //teacherProficiencyReport
            System.out.println("Objective Proficiency by Questions Before Update Grade:"+objProficiencyByQuestion1);
            System.out.println("pass");
            ...
            System.out.println("Student proficiency-percentage: "+studMetaCogProfReport1);
            ...
            System.out.println("Colored marker proficiency:"+colorMarkerProfValue1);
            ...
            System.out.println("Colored marker proficiency By chapter: "+colorMarkerProfByChapValue1);
            ...
            System.out.println("Student ProductivityCogProfReport: "+studProdCogProfReport1);
            ...
            System.out.println("Productivity Colored marker proficiency:"+prodColorMarkerProfValue1);
            ...
            System.out.println(" Productivity Colored marker proficiency By chapter:"+prodColorMarkerProfByChapValue1);
            ...
            System.out.println("Productivity Colored marker proficiency By Objective:"+prodColorMarkerProfByObjectiveValue1);
            ...
            System.out.println("Most Challenging proficiency By chapter:"+mostProficiency1);

            //Expected 2 Chapter Performance' should be updated taking the changed grade for that assignment.

            String mostPerformance1=mostChallengingReport.getStudChapPerformance().get(0).getText().trim();
            System.out.println("pass");
            System.out.println("Most Challenging performance By chapter:"+mostPerformance1);
            ...
            System.out.println("Most Challenging proficiency By Objective:" + mostObjectiveProficiency1);
            Thread.sleep(5000);
            //Expected 2 "Learning Objective Performance" should be updated taking the changed grade for that assignment
            String mostObjectivePerformance1=mostChallengingReport.getStudChapPerformance().get(1).getText().trim();
            System.out.println("pass");
            System.out.println("Most Challenging performance By Objective:"+mostObjectivePerformance1);
        ...
        {
            Assert.fail("Exception in test case gradableAssignmentWithoutPolicyInStudentSide of class GradableAssignmentWithoutPolicyInStudentSide", e);
        }
       }
    }
