 ...
 */
public class AssignPointsLinePlot extends Driver {


    @Test(priority = 1, enabled = true)
    public void addingPointsLinePlot() {
        //Adding the points to Line Plot question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 22;
            ...
            Assert.fail("Exception in testcase 'addingPointsLinePlot' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionLinePlot() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("1171","Me");
            tloListPage.getCheckbox().click();//Select the question
            trueFalse.getButton_review().click();//Click on review button
            Thread.sleep(2000);
            listPage.getArrowLink().click();//Click on arrow
            new WebDriverWait(driver,20).until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("points-input-edit-icon")));
            trueFalse.getPoint_editor().click();//Click on point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionLinePlot' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsLinePlot(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsLinePlot' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsLinePlot(){
        try{String appendChar = "a";
            int dataIndex = 1366;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsLinePlot' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForLinePlot(){
        try{String appendChar = "a";
            int dataIndex = 1430;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForLinePlot' in class 'AssignPoints'", e);
        }
    }


    public void addLinePlotQuestion(int index){
            try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
                ...
                new Click().clickByid("numberLineAnsBox_12");//Click on line plot section

            }catch (Exception e){
                Assert.fail("Exception in testcase 'addLinePlotQuestion' in class 'AssignPoints'", e);
