 ...
 */
public class AssignPointsRangePlotter extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsRangePlotter() {
        //Adding the points to RangePlotter question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 2033;
            ...
            addRangePlotterQuestion(dataIndex);
           ...
           new Assignment().submitPreviewQuestion();
            ...
            Assert.fail("Exception in testcase 'addingPointsRangePlotter' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionRangePlotter() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("2169","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionRangePlotter' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsRangePlotter(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsRangePlotter' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 4,enabled = true)
    //Assigning the points
    public void gradedExplicitByTeacherNotToChangePointsRangePlotter(){
        try{String appendChar = "a";
            int dataIndex = 2363;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsRangePlotter' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForRangePlotter(){
        try{String appendChar = "a";
            int dataIndex = 2422;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForRangePlotter' in class 'AssignPoints'", e);
        }
    }


    public void addRangePlotterQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addRangePlotterQuestion' in class 'AssignPoints'", e);
