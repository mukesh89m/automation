 ...
 */
public class AssignPointsResequence extends Driver {


    @Test(priority = 1, enabled = true)
    public void addingPointsResequence() {
        //Adding the points to Resequence question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 6008;
            ...
            addResequenceQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsResequence' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionResequence() {
        try {
            String appendChar = "a";
            ...
            new Login().loginAsInstructor(appendChar, dataIndex);//Login as a teacher
            new School().createWithOnlyName(appendChar, dataIndex);//create school
            new Classes().createClass(appendChar, dataIndex,"Grade 7","Mathematics","Math - Common Core");//create class
            ...
            new Classes().createClass(appendChar1, dataIndex,"Grade 7","Mathematics","Math - Common Core");//create class
            new Navigator().logout();//log out
            ...
            new Assignment().selectOwner("6145","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionResequence' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsResequence(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsResequence' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsResequence(){
        try{String appendChar = "a";
            int dataIndex = 6341;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsResequence' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForResequence(){
        try{
            String appendChar = "a";
            int dataIndex = 6400;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForResequence' in class 'AssignPoints'", e);
        }
    }

    public void addResequenceQuestion(int index){
