 ...
 */
public class GradableAssignmentWithPolicyFourInStudentSide extends Driver{

    @Test(priority = 1, enabled = true)
    public void gradableAssignmentWithPolicyFourInStudentSide() {
        ...
        try {
            ...
            String assignmentpolicyname = ReadTestData.readDataByTagName("", "assignmentpolicyname", "324");

            new LoginUsingLTI().ltiLogin("324_1");//login as student
            new LoginUsingLTI().ltiLogin("324");//login as instructor
            new Assignment().create(324);
            for(int i=0;i<11;i++)
                new Assignment().addQuestions(324,"truefalse","");
            ...
            new Assignment().assignToStudent(324);//assign to student

            new LoginUsingLTI().ltiLogin("324_1");//login as student
            new Assignment().submitAssignmentAsStudent(324); //submit assignment
            ...
            new LoginUsingLTI().ltiLogin("324");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(324); //provide grade to all question
            ...
            Assert.assertEquals(driver.findElement(By.xpath("//span[@title='(shor)  Assignment_IT18_324']")).isDisplayed(), true, " Student is not navigated to 'Assignment Summary' page");
        ...
        {
            Assert.fail("Exception in test case gradableAssignmentWithPolicyFourInStudentSide of class GradableAssignmentWithPolicyFourInStudentSide", e);
        }
    }
