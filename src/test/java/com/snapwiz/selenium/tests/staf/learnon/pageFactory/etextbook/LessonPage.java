package com.snapwiz.selenium.tests.staf.learnon.pageFactory.etextbook;
...
public class LessonPage {
    ...
    public WebElement getAssignForImage(){ return assignForImage; }

    @FindBy(className = "assign-this-text")
    WebElement assignThisLinkForImage;
    public WebElement getAssignThisLinkForImage(){ return assignThisLinkForImage; }
    ...
    public WebElement getAssignmentsTab(){ return assignmentsTab; }
    ...
    public WebElement getRetakeLink(){return retakeLink;}
    ...
    public WebElement getToc(){ return tocLink; }
    ...
    public WebElement getNoLink(){ return noLink; }
    ...
    public WebElement getYesLink(){ return yesLink; }
