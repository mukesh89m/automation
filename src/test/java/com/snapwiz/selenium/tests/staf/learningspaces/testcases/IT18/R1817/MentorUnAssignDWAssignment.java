 ...
 */
public class MentorUnAssignDWAssignment extends Driver {
    ...
    public void unAssignGradableDWAssignment()
    {
        try
        {
            ...
            new LoginUsingLTI().ltiLogin("167_1");		//login as student1
            new LoginUsingLTI().ltiLogin("167_2");      //login as student2
            new LoginUsingLTI().ltiLogin("167");		//login as instructor
            new Navigator().NavigateTo("eTextbook");	//navigate to etextbook
            new TopicOpen().openLessonWithDiscussionWidget();
            new DiscussionWidget().assignDiscussionWidget("167");
            ...
            popUpFound = new BooleanValue().presenceOfElement(167, By.className("delete-notification"));
            ...
            assessmentFound = new BooleanValue().presenceOfElement(167, By.className("ls-assignment-name-block"));
            ...
            csEntry = new BooleanValue().presenceOfElement(167, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
        ...
        {
            Assert.fail("Exception in class MentorUnAssignDWAssignment in method unAssignGradableDWAssignment.", e);
        }
    }
    ...
    public void unAssignNonGradableDWAssignment()
    {
        try
        {
            ...
            new LoginUsingLTI().ltiLogin("168_1");		//login as student1
            new LoginUsingLTI().ltiLogin("168_2");      //login as student2
            new LoginUsingLTI().ltiLogin("168");		//login as instructor
            new Navigator().NavigateTo("eTextbook");	//navigate to etextbook
            new TopicOpen().openLessonWithDiscussionWidget();
            new DiscussionWidget().assignDiscussionWidget("168");
            new Navigator().NavigateTo("Current Assignments");
            //On the assignment summary page of the instructor,the current option of “Delete Assignment” should be changed to “Unassign Assignment”.
            //TC row no. 168
            str = currentAssignments.getUnAssignAssignment_button().getText();
            ...
            //Expected: The pop-up message should disappear.//
            currentAssignments.getCloseForUnAssign_icon().click();//click on Close icon
            popUpFound = new BooleanValue().presenceOfElement(168, By.className("delete-notification"));
            Assert.assertEquals(popUpFound, false, "The pop-up message doesn't disappear after clicking on Close icon");
            ...
            assessmentFound = new BooleanValue().presenceOfElement(168, By.className("ls-assignment-name-block"));
            Assert.assertEquals(assessmentFound, true, "clicking on NO link on Un-assign assignment pop-up it Unassigns the assignment");
            ...
            //Expected: The assignment entry should get removed  along with social elements from Course Stream Page
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            csEntry = new BooleanValue().presenceOfElement(168, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            Assert.assertEquals(csEntry, false, "On CS ,the assignment entry does not get removed from Course Stream tab.");
            //TC row no. 173, 174
            //"11. Select the lesson page where assignment is associated
            //12. Go to Assignment tab"
