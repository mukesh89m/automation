 ...
 */
public class AssignPointsClozeMatrix extends Driver{

    @Test(priority = 1, enabled = true)
    public void addingPointsClozeMatrix() {
        //Adding the points to ClozeMatrix question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 5514;
            ...
            addClozeMatrixQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsClozeMatrix' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 2, enabled = true)
    public void pointAssignedToParticularQuestionClozeMatrix() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("5649","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionClozeMatrix' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 3,enabled = true)
    public void gradedOnAssignmentSubNotToChangePointsClozeMatrix(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsClozeMatrix' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 4,enabled = true)
    //Assigning the points
    public void gradedExplicitByTeacherNotToChangePointsClozeMatrix(){
        try{String appendChar = "a";
            int dataIndex = 5842;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsClozeMatrix' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForClozeMatrix(){
        try{
            String appendChar = "a";
            int dataIndex = 5900;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForClozeMatrix' in class 'AssignPoints'", e);
        }
    }


    public void addClozeMatrixQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addClozeMatrixQuestion' in class 'AssignPoints'", e);
