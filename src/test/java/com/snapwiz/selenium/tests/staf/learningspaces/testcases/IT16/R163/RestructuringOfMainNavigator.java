 ...
 */
public class RestructuringOfMainNavigator extends Driver{
    ...
    public void restructuringOfMainNavigator()
    {
        try
        {
            ...
            //TC row no. 4..Instructor should navigate to the current “Assignments” page.
            ...
            if(!summaryUrl.contains("assignment"))
                Assert.fail("On clicking \"Summary\" Instructor does not navigate to the current \"Assignments\" page.");

            //TC row no. 5..Instructor should navigate to a new page which contains ONLY assessments.
            ...
            if(!qBanks.contains("myQuestionBanks"))
                Assert.fail("On clicking \"Question Banks\" Instructor does not navigate to the  \"Question Banks\" page.");

            //TC row no. 6...Instructor should navigate to the current “Assignment Policies” page.
            ...
            if(!policies.contains("assignmentPolicy"))
                Assert.fail("On clicking \"Policies\" Instructor does not navigate to the  \" Assignment Policies\" page.");

            //TC row no. 3...Instructor should navigate to the current Resources page
            ...
            if(!resource.contains("resources"))
                Assert.fail("On clicking \"Resources\" Instructor does not navigate to the  current Resources page.");
    ...
    public void enhancementToResourcePage()
    {
        try
        {
            ...
            new Navigator().NavigateTo("Resources");
            Thread.sleep(2000);
            driver.findElement(By.xpath("//div[@id='ls-assessment-filter-chapter-drop-down-wrapper']/div/a[text()='All Chapters']")).click();
            Thread.sleep(2000);
            driver.findElement(By.partialLinkText("Ch 1")).click();//select Chapter 1
            Thread.sleep(2000);
            driver.findElement(By.xpath("//div[@id='ls-assessment-filter-topic-drop-down-wrapper']/div/a[text()='All Sections']")).click();
            Thread.sleep(2000);
        ...
        {
            Assert.fail("Exception in test case enhancementToResourcePage in class InstructorAbleToNavigateToGradeBook.", e);
        }
    }
