 ...
 */
public class InstructorEditAndSaveGradeForPolicyOne extends Driver {

    @Test(priority = 1, enabled = true)
    public void instructorEditAndSaveGradeForGradableAssignmentPolicyOne() {
        ...
        try {
            ...
            String assignmentpolicyname = ReadTestData.readDataByTagName("", "assignmentpolicyname", "93");

            new LoginUsingLTI().ltiLogin("93_1");//login as student
            new LoginUsingLTI().ltiLogin("93");//login as instructor
            new Assignment().create(93);
            for(int i=0;i<11;i++)
                new Assignment().addQuestions(93,"truefalse","");
            new LoginUsingLTI().ltiLogin("93");//login as instructor
            ...
            new Assignment().assignToStudent(93);//assign to student

            new LoginUsingLTI().ltiLogin("93_1");//login as student
            new Assignment().submitAssignmentAsStudent(93); //submit assignment
            ...
            new LoginUsingLTI().ltiLogin("93");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(93); //provide grade to all questions
           ...
           // System.out.println("Colored marker proficiency By Objective: "+colorMarkerProfByObjectiveValue1);
            ...
            System.out.println("prodColorMarkerProf1:"+prodColorMarkerProf1);
            ...
            //Expected 93 Chapter Proficiency' should be updated taking the changed grade for that assignment.
            ...
            Assert.fail("Exception in test case instructorEditAndSaveGradeForGradableAssignmentPolicyOne of class InstructorEditAndSaveGradeForPolicyOne", e);
        }
    }
