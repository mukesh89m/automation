 ...
 */
public class AssignPointsTextDropDown extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingTextDropDown() {
        //Adding the points to TextDropDown question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 1533;
            ...
            addTextDropDownQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingTextDropDown' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 2, enabled = true)
    public void pointAssignedToParticularQuestionTextDropDown() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("1673","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionTextDropDown' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 3,enabled = true)
    public void gradedOnAssignmentSubNotToChangePointsTextDropDown(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsTextDropDown' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 4,enabled = true)
    //Assigning the points
    public void gradedExplicitByTeacherNotToChangePointsTextDropDown(){
        try{String appendChar = "a";
            int dataIndex = 1866;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsTextDropDown' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForTextDropDown(){
        try{String appendChar = "a";
            int dataIndex = 1923;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForTextDropDown' in class 'AssignPoints'", e);
        }
    }


    public void addTextDropDownQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addTextDropDown' in class 'AssignPoints'", e);
