...
/**
 * Created by mukesh on 4/9/15.
 */
public class LangaugePaletteForQuestionCreation  extends Driver{
    ...
    public void langaugePaletteForBrowseForSpanishTrueFalse(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("True / False",dataIndex);
            Thread.sleep(3000);
    ...
    public void langaugePaletteForBrowseForSpanishEssayType(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Essay Type", dataIndex);
    ...
    public void langaugePaletteForBrowseForSpanishWorkboard(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Workboard", dataIndex);
    ...
    public void langaugePaletteForBrowseForSpanishaudio(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Audio Recorder",dataIndex);
     ...
     @Test(priority = 23,enabled = true)
      public void langaugePaletteForBrowseForSpanishMatchthefollowing(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Match the following",dataIndex);
      ...
      public void langaugePaletteForBrowseForSpanishDragandDrop(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Drag and Drop",dataIndex);
    ...
    public void langaugePaletteForBrowseForSpanishLabelanimageText(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Label an image (Text)",dataIndex);
    ...
    public void langaugePaletteForBrowseForSpanishLabelanimageDropdown(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Label an image (Dropdown)",dataIndex);
    ...
    @Test(priority = 27,enabled = true)
      public void langaugePaletteForBrowseForSpanishExpressionEvaluator(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Expression Evaluator",dataIndex);
    ...
    @Test(priority = 28,enabled = true)
      public void langaugePaletteForBrowseForSpanishAdvancedNumeric(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Advanced Numeric",dataIndex);
     ...
     @Test(priority = 29,enabled = true)
      public void langaugePaletteForBrowseForSpanishMultipleSelection(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Multiple Selection",dataIndex);
      ...
      public void langaugePaletteForBrowseForSpanishTextEntry(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Text Entry",dataIndex);
    ...
    @Test(priority = 31,enabled = true)
      public void langaugePaletteForBrowseForSpanishTextDropDown(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Text Drop Down",dataIndex);
      ...
      public void langaugePaletteForBrowseForSpanishNumericEntryunits(){
        try {
            ...
            new OpenSearchPage().OpenBrowsePageAndFilterChapterName("Numeric Entry w/units",dataIndex);
    ...
    public void langaugePaleteForQuestionPreviewTrueFalse(){
        try {
            ...
            Thread.sleep(3000);
            new Click().clickbyxpath("//div[@title='" + assessmentname + "']");
            new CMSActions().navigateToQuestionNo(count);
            count++;
    ...
    public  static void clickOnLanguagePalette()
    {
    ...
    public static void clickOnTheSpanish()
    {
        WebDriver driver=new Driver().driver;
        ManageContent manageContent = PageFactory.initElements(driver, ManageContent.class);
    ...
    public static void clickOnTheItalian()
    {
        WebDriver driver=new Driver().driver;
        ManageContent manageContent = PageFactory.initElements(driver, ManageContent.class);
    ...
    public  static void clickOnTheFrench()
    {
        WebDriver driver=new Driver().driver;
        ManageContent manageContent = PageFactory.initElements(driver, ManageContent.class);
