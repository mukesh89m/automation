 ...
 */
public class AssignPointsMatchTheFollowing extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsMatchTheFollowing() {
        //Adding the points to MatchTheFollowing question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 3524;
            ...
            addMatchTheFollowing(dataIndex);
           ...
           new Assignment().submitPreviewQuestion();
            ...
            Assert.fail("Exception in testcase 'addingPointsMatchTheFollowing' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionMatchTheFollowing() {
        try {
            String appendChar = "a";
            ...
            new Login().loginAsInstructor(appendChar, dataIndex);//Login as a teacher
            new School().createWithOnlyName(appendChar, dataIndex);//create school
            new Classes().createClass(appendChar, dataIndex,"Grade 9","Mathematics","Math - Common Core");//create class
            ...
            new Classes().createClass(appendChar1, dataIndex,"Grade 9","Mathematics","Math - Common Core");//create class
            new Navigator().logout();//log out
            ...
            new Assignment().selectOwner("3661","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionMatchTheFollowing' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 3,enabled = true)
    public void gradedOnAssignmentSubNotToChangePointsMatchTheFollowing(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsMatchTheFollowing' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsMatchTheFollowing(){
        try{String appendChar = "a";
            int dataIndex = 3855;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsMatchTheFollowing' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForMatchTheFollowing(){
        try{String appendChar = "a";
            int dataIndex = 3912;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForMatchTheFollowing' in class 'AssignPoints'", e);
        }
    }


    public void addMatchTheFollowing(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            new WebDriverWait(driver,20).until(ExpectedConditions.invisibilityOfElementLocated(By.id("widget-createimage_start_queue")));
            ...
            Assert.fail("Exception in testcase 'addMatchTheFollowing' in class 'AssignPoints'", e);
