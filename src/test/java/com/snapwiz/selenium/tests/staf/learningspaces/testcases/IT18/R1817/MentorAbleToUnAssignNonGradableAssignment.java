 ...
 */
public class MentorAbleToUnAssignNonGradableAssignment extends Driver {

    @Test(priority = 1, enabled = true)
    public void mentorAbleToUnAssignNonGradableAssignment()
    {
        try
        {
            ...
            new LoginUsingLTI().ltiLogin("68_1");		//login as student1
            new LoginUsingLTI().ltiLogin("68_2");    //login as student2
            new LoginUsingLTI().ltiLogin("68");		//login a mentor
            ...
            popUpFound = new BooleanValue().presenceOfElement(68, By.className("delete-notification"));
            ...
            classActivity = new BooleanValue().presenceOfElement(68, By.id("course-stream"));
            ...
            csEntry = new BooleanValue().presenceOfElement(68, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            ...
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            boolean csEntry1 = new BooleanValue().presenceOfElement(68, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
        ...
        {
            Assert.fail("Exception in class MentorAbleToUnAssignNonGradableAssignment in method MentorAbleToUnAssignNonGradableAssignment.", e);
        }
    }
