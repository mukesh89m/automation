 ...
 */
public class StudentAttemptedQuestionsOfFewTlosAndInstructorHiddenTheAllTloOfChapter {

    @Test
    public void studentAttemptedQuestionsOfFewTlosAndInstructorHiddenTheAllTloOfChapter()
    {
        try
        {
            Driver.startDriver();
            new LoginUsingLTI().ltiLogin("98_1");        //login as student
            ...
            new LoginUsingLTI().ltiLogin("98");        //login as instructor
            ...
            {
                new Screenshot().captureScreenshotFromTestCase();
                Assert.fail("TLO which is OFF is not shown in the student side metacognitive report.");
            }
            //TC row no. 105
        ...
        {
            new Screenshot().captureScreenshotFromTestCase();
            Assert.fail("Exception in testcase studentAttemptedQuestionsOfFewTlosAndInstructorHiddenTheAllTloOfChapter in class StudentAttemptedQuestionsOfFewTlosAndInstructorHiddenTheAllTloOfChapter.", e);
        }
    }
    @AfterMethod
