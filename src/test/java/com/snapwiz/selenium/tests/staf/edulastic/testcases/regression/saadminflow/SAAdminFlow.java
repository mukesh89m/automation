package com.snapwiz.selenium.tests.staf.edulastic.testcases.regression.saadminflow;
...
/**
 * Created by Murthi on 10/12/2016.
 */

public class SAAdminFlow extends Driver {

    public  static String totalScore=null;
    @Test(priority = 1, enabled = true)
    public void sAAdminFlowForAllClasses() {
        WebDriver driver = Driver.getWebDriver();
        try {
            ReportUtil.log("Description", "This test case verifies the DAAdmin flow assigned to all classes in the district", "info");

            String appendChar = "a" + StringUtil.generateRandomString(5, StringUtil.Mode.ALPHA);
            //String appendChar = "asVmlV" ;
          ...
          /*  WebDriverUtil.waitForAjax(driver,60);
            new WebDriverWait(driver,60).until(ExpectedConditions.invisibilityOfElementLocated(By.id("toast-container")));
            WebElement reviewAssignment=driver.findElements(By.className("lsm-createAssignment-done")).get(3);
            new Actions(driver).moveToElement(reviewAssignment).click(reviewAssignment).perform();//click on review assignment
            WebDriverUtil.waitForAjax(driver,60);
            WebElement saveAsDraft=driver.findElement(By.id("assessments-save-later-button"));
            saveAsDraft.click();
            WebDriverUtil.waitForAjax(driver,60);*/
            ...
            CustomAssert.assertEquals(studentResponse.explicitlyByDistrictAdmin.getText(), "Gradable - Explicitly by School Admin", "Verify the Explicitly by School Admin text for instructor", "Explicitly by School Admin  is displayed as expected", "Explicitly by School Admin is not displayed");
            ...
            new Actions(driver).click(driver.findElement(By.xpath("(//div[@id='view-user-question-performance-score-box'])[2]"))).perform();
            driver.findElement(By.xpath("//input[@data-id='score']")).clear();
            driver.findElement(By.xpath("//input[@data-id='score']")).sendKeys("1");

            driver.findElements(By.cssSelector("#question-points")).get(1).click();//click outside of the score input box
            Thread.sleep(5000);
            ...
            WebDriverUtil.clickOnElementUsingJavascript(districtAssessmentResponse.releaseGrade_link);//Click on release grade button
    ...
    public void sAAdminFlowForParticularClass() {
        WebDriver driver = Driver.getWebDriver();
        try {
...
//
            String appendChar1="abS";
            String appendChar2="bCU";
...
//            driver.findElements(By.cssSelector("rect[width='40']")).get(1).click();
            ...
            //Manually assign grade for essay type question(Q2
            WebDriverUtil.clickOnElementUsingJavascript(driver.findElement(By.xpath("(//div[@id='view-user-question-performance-score-box'])[2]")));
            driver.findElement(By.xpath("//input[@data-id='score']")).clear();
            driver.findElement(By.xpath("//input[@data-id='score']")).sendKeys("1");
            ...
            int index=0;
            for (WebElement ca : assignments.assignmentName) {
                if (ca.getText().equals(assessmentname)) {
                    break;
                }
                index++;
            ...
            assignments.viewResponse.get(index).click();//Click on view response
            Thread.sleep(1000);
    ...
    public void sAAdminFlowAssignedByInstructor() {
        WebDriver driver = Driver.getWebDriver();
        try {
...
//            String appendChar="aAu";
            ...
            //Manually assign grade for essay type question(Q2
            WebDriverUtil.clickOnElementUsingJavascript(driver.findElement(By.xpath("(//div[@id='view-user-question-performance-score-box'])[3]")));
            driver.findElement(By.xpath("//input[@data-id='score']")).clear();
            driver.findElement(By.xpath("//input[@data-id='score']")).sendKeys("1");
//            Thread.sleep(1000);
            driver.findElements(By.cssSelector("#question-points")).get(2).click();//click outside of the score input box
            Thread.sleep(2000);
