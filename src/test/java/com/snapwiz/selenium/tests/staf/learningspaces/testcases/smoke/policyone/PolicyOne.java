package com.snapwiz.selenium.tests.staf.learningspaces.testcases.smoke.policyone;
...
/**
 * Created by priyanka on 10-02-2016.
 */
public class PolicyOne extends Driver {

    String actual;
    String expected;

    @Test(priority = 1, enabled = true)
    public void policyOne() {
        try {
            ...
            ReportUtil.log("Description","This test case validates creation of 12 questions,instructor assign assignment with policy1 to class section,assignment submitted by students,report verification at student and instructor side","info");
