...
public class Config {
	...
	public static String custom_lms_type;
	public static String content_item_return_url;
	public static String oauth_callback;
	public static String lti_message_type;
	public static void readconfiguration()
	{
		 try {
			String workingDir = System.getProperty("user.dir");
			File fXmlFile = new File(workingDir+"/src/test/java/com/snapwiz/selenium/tests/staf/learningspaces/config.xml");
			...
			for (int temp = 0; temp < nList.getLength(); temp++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					custom_lms_type = eElement.getElementsByTagName("custom_lms_type").item(0).getTextContent();
					content_item_return_url = eElement.getElementsByTagName("content_item_return_url").item(0).getTextContent();
					oauth_callback = eElement.getElementsByTagName("oauth_callback").item(0).getTextContent();
					lti_message_type=eElement.getElementsByTagName("lti_message_type").item(0).getTextContent();
