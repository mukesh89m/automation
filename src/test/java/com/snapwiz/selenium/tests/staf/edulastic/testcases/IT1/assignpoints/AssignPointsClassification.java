 ...
 */
public class AssignPointsClassification extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsClassification() {
        //Adding the points to Classification question explicitly
        try {
            String appendChar = "b";
            int dataIndex = 8995;
            ...
            addClassificationQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsClassification' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionClassification() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("9132","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionClassification' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 3,enabled = true)
    public void gradedOnAssignmentSubNotToChangePointsClassification(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsClassification' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsClassification(){
        try{String appendChar = "a";
            int dataIndex = 9326;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsClassification' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForClassification(){
        try{String appendChar = "a";
            int dataIndex = 9384;
            ...
            addClassificationQuestion(9385);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("4");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            trueFalse.getButton_review().click();//Click on review button
            listPage.getButton_addMore().click();//Click on add more button
            addClassificationQuestion(9386);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("5");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForClassification' in class 'AssignPoints'", e);
        }
    }


    public void addClassificationQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            new Click().clickByid("qtn-classification-type");//Click on Classification type question
            closeHelp();
            ...
            ac.dragAndDrop(driver.findElements(By.id("ans-drag-btn")).get(3), dstanswersToDrop).build().perform();


        }catch (Exception e){
            Assert.fail("Exception in testcase 'addClassificationQuestion' in class 'AssignPoints'", e);
