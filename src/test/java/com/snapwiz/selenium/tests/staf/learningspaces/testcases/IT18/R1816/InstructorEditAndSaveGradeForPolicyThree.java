...
/**
 * Created by Mukesh on 1/2/15.
 */
public class InstructorEditAndSaveGradeForPolicyThree extends Driver{

    @Test(priority = 1, enabled = true)
    public void instructorEditAndSaveGradableAssignmentPolicyThree() {
        ...
        try {
            ...
            new LoginUsingLTI().ltiLogin("145_1");//login as student
            new LoginUsingLTI().ltiLogin("145");//login as instructor
            new Assignment().create(145);
            new Assignment().addQuestions(145, "essay", "");
            new Assignment().addQuestions(145, "essay", "");
            for(int i=0;i<9;i++)
                new Assignment().addQuestions(145,"truefalse","");
            new LoginUsingLTI().ltiLogin("145");//login as instructor
            new Navigator().NavigateTo("Policies");//navigate to Assignment Policies
            new AssignmentPolicy().createAssignmentPolicy(assignmentpolicyname, "Policy description", "2", null, false, "1", "", "Release as they are being graded", "", "", "");//till save polic

            new Navigator().NavigateTo("Assignments");//navigate to Assignments
            new Assignment().assignToStudent(145);//assign to student

            new LoginUsingLTI().ltiLogin("145_1");//login as student
            new Assignment().submitAssignmentAsStudent(145); //submit assignment*/
            new LoginUsingLTI().ltiLogin("145");//login as instructor
            new Assignment().provideGradeToStudentForMultipleQuestions(145);
            ...
            System.out.println("Teacher Proficiency Report:"+teacherProficiencyReport);
            ...
            System.out.println("classProficiencyReportByQuestion:"+classProficiencyReportByQuestion);
            ...
            System.out.println("engagQuestionPercentage:"+engagQuestionPercentage);
            ...
            new LoginUsingLTI().ltiLogin("145");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(146); //provide grade to all questions
            ...
            System.out.println("Teacher Proficiency Report:"+teacherProficiencyReport1);
            System.out.println("pass");
            ...
            System.out.println("classProficiencyReportByQuestion1:"+classProficiencyReportByQuestion1);
            ...
            System.out.println("engagQuestionPercentage1:"+engagQuestionPercentage1);
          ...
          //  Assert.assertNotEquals(classProficiencyReportByQuestion,classProficiencyReportByQuestion1,"Class Performance by Question is not updated");
            ...
            //Expected 145 Chapter Proficiency' should be updated taking the changed grade for that assignment.
            ...
            Assert.fail("Exception in test case instructorEditAndSaveGradeForGradableAssignmentPolicyTwo of class InstructorEditAndSaveGradeForPolicyThree", e);
        }
    }
