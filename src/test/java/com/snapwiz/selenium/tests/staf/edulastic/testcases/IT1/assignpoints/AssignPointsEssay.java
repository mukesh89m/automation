 ...
 */
public class AssignPointsEssay extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointEssay() {
        //Adding the points to Essay question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 7999;
            ...
            Assert.fail("Exception in testcase 'addingPointEssay' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionEssay() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("8136","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionEssay' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsEssay(){
        try{String appendChar = "a";
            ...
            assessments.getButton_save().click();//Click on save button
            assessments.getButton_back().click();//Click on back button
            assessmentResponses.getButton_ReleaseGradeForAll().click();//Click on Release grade
            ...
            assessments.getButton_continue().click();//Click on continue button
            new WebDriverWait(driver,20).until(ExpectedConditions.presenceOfElementLocated(By.id("question-points")));
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsEssay' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsEssay(){
        try{String appendChar = "a";
            int dataIndex = 8331;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsEssay' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForEssay(){
        try{String appendChar = "a";
            int dataIndex = 8389;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForEssay' in class 'AssignPoints'", e);
        }
    }

    public void addEssayQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addEssayQuestion' in class 'AssignPoints'", e);
