...
public class MentorSeeAllDiscussionAndReplytoDiscussion {
	
	@Test
	public void mentororSeeAllDiscussionAndReplytoDiscussion()
	{
		try
		{
			Driver.startDriver();
			...
			new LoginUsingLTI().ltiLogin("1099");//login as student
			...
			new LoginUsingLTI().ltiLogin("10991");//login as instructor
