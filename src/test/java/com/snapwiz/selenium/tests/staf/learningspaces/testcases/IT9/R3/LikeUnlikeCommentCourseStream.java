...
public class LikeUnlikeCommentCourseStream extends Driver{
	
	private static Logger logger = Logger.getLogger("com.snapwiz.selenium.tests.staf.learningspaces.testcases.LikeUnlikeCommentCourseStream");
	@Test
	public void likeUnlikeCommentCourseStream()
	{
		try
		{
			...
			new LoginUsingLTI().ltiLogin("345");
			 ...
			 * 345
			 */
			driver.findElement(By.className("ls-post-like-link")).click();
			String likecount = driver.findElement(By.className("ls-post-like-count")).getText();
			if(!likecount.equals("1"))
				Assert.fail("Like count of the post not equal to 1");
			/*
			 * 346
			 */
			String likelinkafterclicking = driver.findElement(By.className("ls-post-like-link")).getText();
			 ...
			 */
			driver.findElement(By.className("ls-post-like-link")).click();
			likecount = driver.findElement(By.className("ls-post-like-count")).getText();
			 ...
			 * 349
			 */
			String unlikelikelinkafterclicking = driver.findElement(By.className("ls-post-like-link")).getText();
			...
			new CommentOnPost().commentOnPost(randomstring, 0);
			 ...
			 String comment1text = (String) ((JavascriptExecutor)driver).executeScript("return arguments[0].innerHTML",driver.findElement(By.cssSelector("div[class='ls-stream-post__comment-text']")));
			 ...
			 //Posting IInd Comment 
			   ...
			   new CommentOnPost().commentOnPost(randomstring2, 0);
				List<WebElement> comments = driver.findElements(By.cssSelector("div[class='ls-stream-post__comment-text']"));
				 //String comment2text = (String) ((JavascriptExecutor)driver).executeScript("return arguments[0].innerHTML",comments.get(1));
			...
			*/
						...
						driver.findElement(By.partialLinkText("Comments")).click(); //click on comments link to show comments
			 String viewallcommentslinktext = (String) ((JavascriptExecutor)driver).executeScript("return arguments[0].innerHTML",driver.findElement(By.className("ls-stream-post__view-comments")));
				 ...
				 * 354		
				 */
			driver.findElement(By.cssSelector("i[class='ls-arrow ls-arrow--down']")).click();
			Thread.sleep(2000);
			String hideallcommentslinktext = driver.findElement(By.className("ls-stream-post__view-comments")).getText();
			
			// String hideallcommentslinktext = (String) ((JavascriptExecutor)driver).executeScript("return arguments[0].innerHTML",driver.findElement(By.className("ls-stream-post__view-comments")));
			 ...
			 * 357
			 */
				driver.findElement(By.cssSelector("i[class='ls-arrow ls-arrow--up']")).click();
				String viewallcommentslinktextagain = driver.findElement(By.className("ls-stream-post__view-comments")).getText();
				Thread.sleep(2000);
				// String viewallcommentslinktextagain = (String) ((JavascriptExecutor)driver).executeScript("return arguments[0].innerHTML",driver.findElement(By.className("ls-stream-post__view-comments")));
