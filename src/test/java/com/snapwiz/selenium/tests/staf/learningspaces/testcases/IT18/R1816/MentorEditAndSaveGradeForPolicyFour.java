 ...
 */
public class MentorEditAndSaveGradeForPolicyFour extends Driver {
    @Test(priority = 1, enabled = true)
    public void mentorEditAndSaveGradeForGradableAssignmentPolicyFour() {
        ...
        try {
            ...
            new LoginUsingLTI().ltiLogin("28_1");//login as student
            ...
            new LoginUsingLTI().ltiLogin("28_1");//login as student
            new Assignment().submitAssignmentAsStudent(28); //submit assignment

            new LoginUsingLTI().ltiLogin("28");//login as instructor
            new Assignment().releaseGrades(28, "Release Grade for All");
            ...
            new LoginUsingLTI().ltiLogin("28");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(28); //provide grade to all questions
            ...
            //Tc row no 82 7.Place the cursor on colored marker
            new MouseHover().mouserhoverbywebelement(productivityReport.getColoredMarker());
            new WebDriverWait(driver,360).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='tooltip-label-subsection-wrapper']")));
            ...
            Assert.fail("Exception in test case mentorEditAndSaveGradeForGradableAssignmentPolicyOne of class MentorEditAndSaveGradeForPolicyFour", e);
        }
    }
