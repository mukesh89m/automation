...
public class AttemptQuestion {
	...
	public void trueFalse(boolean useHint, String answerChoice, String dataIndex)
    {
        try
        {
            (new WebDriverWait(Driver.driver, 400))
            ...
            if(!answerChoice.equalsIgnoreCase("skip")) {
               ...
               if (answerChoice.equalsIgnoreCase("incorrect"))
               {
                   ...
                   //Driver.driver.findElement(By.xpath(".//*[@class='true-false-student-answer-select']/span[contains(text(),'B')]")).click();
	...
	public void multipleChoice(boolean useHint, String answerChoice, String dataIndex)
    {
        try
        {
            if(!answerChoice.equalsIgnoreCase("skip")) {
    ...
    public void multipleSelection(boolean useHint, String answerChoice, String dataIndex)
    {
        try
        {
            if(!answerChoice.equalsIgnoreCase("skip")) {
    ...
    public void textEntry(boolean useHint, String answerChoice, String dataIndex)
    {
        try {
    ...
    public void textEntryWithSpanish(boolean useHint, String answerChoice, String dataIndex)
    {
        try {
            ...
            if(!answerChoice.equalsIgnoreCase("skip")) {
                ...
                if (answerChoice.equalsIgnoreCase("correct"))
                {
                    ...
                    Driver.driver.findElement(By.id("spanishPaletteBox")).sendKeys("AA");
    ...
    public void textDropDown(boolean useHint,String answerChoice, String dataIndex)
    {
        try {
            ...
            if(!answerChoice.equalsIgnoreCase("skip")) {
                ...
                if (answerChoice.equalsIgnoreCase("correct"))
                    new com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelper.DropDown().selectValue("class","question-raw-content-dropdown","Answer1");

                else
                    new com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelper.DropDown().selectValue("class","question-raw-content-dropdown","Answer2");
    ...
    public void numericEntryWithUnits(boolean useHint,String answerChoice, String dataIndex)
    {
        try {
            if(!answerChoice.equalsIgnoreCase("skip")) {
                ...
                if (answerChoice.equalsIgnoreCase("correct")) {
                    ...
                    new com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelper.DropDown().selectValue("class","question-raw-content-dropdown","feet");
                }
                else {
    ...
    public void advancedNumeric(boolean useHint,String answerChoice, String dataIndex)
    {
        try {
            if(!answerChoice.equalsIgnoreCase("skip")) {
    ...
    public void expressionEvaluator(boolean useHint,String answerChoice, String dataIndex)
    {
        try {
            Thread.sleep(3000);
            if(!answerChoice.equalsIgnoreCase("skip")) {
    ...
    public void matchTheFollowing(boolean useHint,String answerChoice, String dataIndex)
    {
        try {
            if(!answerChoice.equalsIgnoreCase("skip")) {
    ...
    public void dragAndDrop(boolean useHint,String answerChoice, String dataIndex)
    {
        try {
            if(!answerChoice.equalsIgnoreCase("skip")) {
                Actions ac = new Actions(Driver.driver);
    ...
    public void attemptClozeFormula(boolean useHint, String answerChoice, String dataIndex)
    {
        try {
    ...
    public void essay(boolean useHint,String answerChoice, String dataIndex)
    {
        try
        {
    ...
    public void writeBoard(boolean useHint,String answerChoice, String dataIndex)
    {
        try
        {
    ...
    public void textEntryExactMatch(boolean useHint, String answerChoice, String dataIndex)
    {
        try {
