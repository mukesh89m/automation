 ...
 */
public class MentorEditAndSaveGradeForGradableAssignment extends Driver {

    @Test(priority = 1, enabled = true)
    public void mentorEditAndSaveGradeForGradableAssignment() {
        ...
        try {
            ...
            new LoginUsingLTI().ltiLogin("29"); //login as mentor
             new Assignment().create(29); //create assignment
            for(int i=0;i<11;i++)
                new Assignment().addQuestions(29,"truefalse","");
            new LoginUsingLTI().ltiLogin("29");//login as instructor
            new Assignment().assignToStudent(29); //assign to the student
            new LoginUsingLTI().ltiLogin("29_1"); //login as student
            new Assignment().submitAssignmentAsStudent(29); //submit assignment
            new LoginUsingLTI().ltiLogin("29");//login as instructor
            new Assignment().releaseGrades(29, "Release Grade for All");
            ...
            System.out.println("Student Proficiency Report Before Update Grade:"+studProfReport);
            ...
            System.out.println("Student Proficiency Report  BY Objective Before Update Grade:" + studObjProfReport);
            ...
            System.out.println("Class Performance by Questions Before Update Grade:"+classProficiencyReportByQuestion);
            System.out.println("pass");
            String studObjPerformance=proficiencyReport.getStudProficiency().getText().trim();
            System.out.println("Objective Performance By Students Before Update Grade:"+studObjPerformance);
            Thread.sleep(2000);
            ...
            System.out.println("Student MetaCogProfReport: "+studMetaCogProfReport);
            ...
            System.out.println("prodColorMarkerProf:"+prodColorMarkerProf);
            ...
            System.out.println("Engagement QuestionPercentage:"+engagQuestionPercentage);
            ...
            System.out.println("Student total grade:"+totalGrade);
            ...
            System.out.println("pass");
            System.out.println("GradeBook Overall Score:"+overallScore);

            System.out.println("*******************************************");//After updating  grade
            new LoginUsingLTI().ltiLogin("29");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(29); //provide grade to all questions
            ...
            System.out.println("Student Proficiency Report Before Update Grade:"+studProfReport1);
            ...
            System.out.println("Student Proficiency Report  BY Objective Before Update Grade:" + studObjProfReport1);
            ...
            System.out.println("Class Performance by Questions Before Update Grade:"+classProficiencyReportByQuestion1);
            System.out.println("pass");
            ...
            System.out.println("Student MetaCogProfReport: "+studMetaCogProfReport1);
            ...
            System.out.println("Engagement QuestionPercentage:"+engagQuestionPercentage1);
            //Expected 2:“Total Grade” for each student should be updated taking the changed grade into account for that assignment
            String totalGrade1=engagementReport.getStudTotalGrade().getText().trim();
            System.out.println("pass1");
            System.out.println("Student total grade:"+totalGrade1);

            //Tc row no 92 18.Click on GradeBook from the main navigator
            new Navigator().NavigateTo("Gradebook"); //navigate to grade book
            String overallScore1=engagementReport.getOverallScore().getText().trim();
            System.out.println("pass");
            System.out.println("GradeBook Overall Score:"+overallScore1);
            ...
            //Expected 19 Chapter Proficiency' should be updated taking the changed grade for that assignment.
            ...
            Assert.fail("Exception in test case mentorEditAndSaveGradeForGradableAssignment of class MentorEditAndSaveGradeForGradableAssignment", e);
        }
    }
