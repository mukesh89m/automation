...
/**
 * Created by Mukesh on 12/30/14.
 */
public class InstructorEditAndSaveGrade extends Driver {

    @Test(priority = 1, enabled = true)
    public void instructorEditAndSaveGradeForGradableAssignment() {
        ...
        try {
            ...
            new Assignment().create(67); //create assignment
            for(int i=0;i<11;i++)
                new Assignment().addQuestions(67,"truefalse","");
            new LoginUsingLTI().ltiLogin("67");//login as instructor
            new Assignment().assignToStudent(67); //assign to the student
            new LoginUsingLTI().ltiLogin("67_1"); //login as student
            new Assignment().submitAssignmentAsStudent(67); //submit assignment
            new LoginUsingLTI().ltiLogin("67");//login as instructor
            new Assignment().releaseGrades(67, "Release Grade for All");
           ...
           //Expected 2:“Total Grade” for each student should be updated taking the changed grade into account for that assignment
            ...
            new LoginUsingLTI().ltiLogin("67");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(67); //provide grade to all questions
           ...
           // Expected 12  Proficiency with respect to Chapter should be updated.
            ...
            Assert.fail("Exception in test case instructorEditAndSaveGradeForGradableAssignment of class InstructorEditAndSaveGrade", e);
        }
    }
