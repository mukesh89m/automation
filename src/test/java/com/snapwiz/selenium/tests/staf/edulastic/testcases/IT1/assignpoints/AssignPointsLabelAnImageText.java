 ...
 */
public class AssignPointsLabelAnImageText extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsLabelAnImageText() {
        //Adding the points to LabelAnImageText question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 6509;
            ...
            addLabelAnImageTextQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsLabelAnImageText' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 2, enabled = true)
    public void pointAssignedToParticularQuestionLabelAnImageText() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("6646","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionLabelAnImageText' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsLabelAnImageText(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsLabelAnImageText' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 4,enabled = true)
    //Assigning the points
    public void gradedExplicitByTeacherNotToChangePointsLabelAnImageText(){
        try{String appendChar = "a";
            int dataIndex = 6840;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsLabelAnImageText' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForLabelAnImageText(){
        try{String appendChar = "a";
            int dataIndex = 6900;
            ...
            addLabelAnImageTextQuestion(6901);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("4");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            trueFalse.getButton_review().click();//Click on review button
            listPage.getButton_addMore().click();//Click on add more button
            addLabelAnImageTextQuestion(6902);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("5");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForLabelAnImageText' in class 'AssignPoints'", e);
        }
    }

    public void addLabelAnImageTextQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addLabelAnImageTextQuestion' in class 'AssignPoints'", e);
