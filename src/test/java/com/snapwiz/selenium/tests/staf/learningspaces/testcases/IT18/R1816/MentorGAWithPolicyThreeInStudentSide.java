 ...
 */
public class MentorGAWithPolicyThreeInStudentSide extends Driver {
    @Test(priority = 1, enabled = true)
    public void mentorGAWithPolicyThreeInStudentSide() {
        ...
        try {
            ...
            String assignmentpolicyname = ReadTestData.readDataByTagName("", "assignmentpolicyname", "31");

            new LoginUsingLTI().ltiLogin("31_1");//login as student
            new LoginUsingLTI().ltiLogin("31");//login as instructor
            new Assignment().create(31);
            new Assignment().addQuestions(31, "essay", "");
            new Assignment().addQuestions(31, "essay", "");
            for(int i=0;i<9;i++)
                new Assignment().addQuestions(31,"truefalse","");
            new LoginUsingLTI().ltiLogin("31");//login as instructor
            ...
            new Assignment().assignToStudent(31);//assign to student

            new LoginUsingLTI().ltiLogin("31_1");//login as student
            new Assignment().submitAssignmentAsStudent(31); //submit assignment
            new LoginUsingLTI().ltiLogin("31");//login as instructor
            new Assignment().provideGradeToStudentForMultipleQuestions(31);
            ...
            new LoginUsingLTI().ltiLogin("31");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(32); //provide grade to all question
            ...
            Assert.assertEquals(driver.findElement(By.xpath("//span[@title='Assignment_IT18_31']")).isDisplayed(), true, " Student is not navigated to 'Assignment Summary' page");
        ...
        {
            Assert.fail("Exception in test case mentorGAWithPolicyThreeInStudentSide of class MentorGAWithPolicyThreeInStudentSide", e);
        }
    }
