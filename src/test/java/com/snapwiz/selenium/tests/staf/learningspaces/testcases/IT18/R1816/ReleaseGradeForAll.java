...
/**
 * Created by Mukesh on 12/29/14.
 */
public class ReleaseGradeForAll extends Driver {
    ...
    public void releaseGradeForAllInARP()
    {
        ...
        try {
            ...
            System.out.println("assignmentName:"+assignmentName.size());
            Assert.assertEquals(assignmentName.get(1).getText().trim(),assessmentname,"Same assignment is not present in the Assignment Response page");
            ...
            Thread.sleep(3000);
            currentAssignments.getEnterGrade_link().click(); //click on the enter grade
            Thread.sleep(5000);
            ...
            new UIElement().waitAndFindElement(currentAssignments.getQuestionText());
    ...
    public void gradableAssignmentWithPolicyOne()
    {
        ...
        try {
            ...
            new Assignment().assignToStudent(19);//assign to student

            new LoginUsingLTI().ltiLogin("19_1");//login as student
            new Assignment().submitAssignmentAsStudent(19); //submit assignment
            ...
            Assert.assertEquals(currentAssignments.getResponsePageTitle().getText().trim(),"Assignment Responses"," Instructor has not Navigated to Assignment Response page of that Assignment");
            List<WebElement> assignmentName=driver.findElements(By.cssSelector("span[class='ls-assignment-name instructor-assessment-review']"));
            Assert.assertEquals(assignmentName.get(1).getText().trim(),"Assignment_IT18_1999","Same assignment is not present in the Assignment Response page");
    ...
    public void gradableAssignmentWithPolicyThree()
    {
        ...
        try {
            CurrentAssignments currentAssignments= PageFactory.initElements(driver,CurrentAssignments.class);
            String assignmentpolicyname = ReadTestData.readDataByTagName("", "assignmentpolicyname", "33");
            String questiontext = ReadTestData.readDataByTagName("", "questiontext", "33");
            System.out.println("assignmentpolicyname:"+assignmentpolicyname);
            String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", "33");
            ...
            new Assignment().addQuestions(33, "essay", "");
            ...
            new Navigator().NavigateTo("Assignments");//navigate to Assignments
            new Assignment().assignToStudent(33);//assign to student

            new LoginUsingLTI().ltiLogin("33_1");//login as student
            new Assignment().submitAssignmentAsStudent(33); //submit assignment
            ...
            Assert.assertEquals(currentAssignments.getResponsePageTitle().getText().trim(),"Assignment Responses"," Instructor has not Navigated to Assignment Response page of that Assignment");
            List<WebElement> assignmentName=driver.findElements(By.cssSelector("span[class='ls-assignment-name instructor-assessment-review']"));
            Assert.assertEquals(assignmentName.get(1).getText().trim(),"Assignment_IT18_33","Same assignment is not present in the Assignment Response page");
    ...
    public void gradableAssignmentWithPolicyFour()
    {
        ...
        try {
            CurrentAssignments currentAssignments= PageFactory.initElements(driver,CurrentAssignments.class);
            String assignmentpolicyname = ReadTestData.readDataByTagName("", "assignmentpolicyname", "40");
            String questiontext = ReadTestData.readDataByTagName("", "questiontext", "40");
            new LoginUsingLTI().ltiLogin("40_1");//login as student
            new LoginUsingLTI().ltiLogin("40");//login as instructor
            new Assignment().create(40); //create assignment
            new Assignment().addQuestions(40, "truefalse", "");
            ...
            new Navigator().NavigateTo("Assignments");//navigate to Assignments
            new Assignment().assignToStudent(40);//assign to student

            new LoginUsingLTI().ltiLogin("40_1");//login as student
            new Assignment().submitAssignmentAsStudent(40); //submit assignment

            new LoginUsingLTI().ltiLogin("40");//login as instructor
            new Assignment().releaseGrades(40, "Release Grade for All");
            new Navigator().NavigateTo("Current Assignments");// navigate to the assignment summary page
            currentAssignments.getViewGrade_link().click();//click on the view grade link
            //Expected 1 It should Navigate to Assignment Response page of that Assignment.
            Assert.assertEquals(currentAssignments.getResponsePageTitle().getText().trim(),"Assignment Responses"," Instructor has not Navigated to Assignment Response page of that Assignment");
            List<WebElement> assignmentName=driver.findElements(By.cssSelector("span[class='ls-assignment-name instructor-assessment-review']"));
            Assert.assertEquals(assignmentName.get(1).getText().trim(),"Assignment_IT18_40","Same assignment is not present in the Assignment Response page");
    ...
    public void nonGradableAssignmentQuestionType()
    {
        ...
        try {
            CurrentAssignments currentAssignments= PageFactory.initElements(driver,CurrentAssignments.class);
            String questiontext = ReadTestData.readDataByTagName("", "questiontext", "47");
            new LoginUsingLTI().ltiLogin("47_1");//login as student

            new Assignment().create(47); //create assignment
            new Assignment().addQuestions(47,"truefalse","");
            ...
            new Assignment().releaseGrades(47, "Release Feedback for All");//click on the release feedback
            new Navigator().NavigateTo("Current Assignments");// navigate to the assignment summary page
            currentAssignments.getViewGrade_link().click();//click on the view feedback link
            //Expected 1 It should Navigate to Assignment Response page of that Assignment.
            Assert.assertEquals(currentAssignments.getResponsePageTitle().getText().trim(),"Assignment Responses"," Instructor has not Navigated to Assignment Response page of that Assignment");
            List<WebElement> assignmentName=driver.findElements(By.cssSelector("span[class='ls-assignment-name instructor-assessment-review']"));
            Assert.assertEquals(assignmentName.get(1).getText().trim(),"Assignment_IT18_47","Same assignment is not present in the Assignment Response page");
    ...
    public void gradableDwAssignment()
    {
        ...
        try {
            CurrentAssignments currentAssignments= PageFactory.initElements(driver,CurrentAssignments.class);
            new LoginUsingLTI().ltiLogin("53_1");//login as student
            ...
            new LoginUsingLTI().ltiLogin("53"); //login as instructor
            new Assignment().releaseGrades(53, "Release Grade for All");
    ...
    public void nonGradableDwAssignment()
    {
        ...
        try {
            ...
            new Navigator().NavigateTo("e-Textbook");
            new TopicOpen().openLessonWithDiscussionWidget();//open chapter10.3
            new DiscussionWidget().assignDiscussionWidgetWithDefaultClassSection(60);

            new LoginUsingLTI().ltiLogin("60_1");//login a student
            new Navigator().NavigateTo("Assignments");	//navigate to Assignment
            new Click().clickByclassname("learning-activity-title"); //click on DW
            String perspective = new RandomString().randomstring(10);
            new DiscussionWidget().addPerspectiveForDWAssignment(perspective); //add perspective to DW assignment
            ...
            new LoginUsingLTI().ltiLogin("60"); //login as instructor
            new Assignment().provideFeedBackForMultipleQuestion(60, "This is a New FeedbackText");
