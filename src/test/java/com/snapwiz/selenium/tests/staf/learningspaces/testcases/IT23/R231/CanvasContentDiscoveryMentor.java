 ...
 */
public class CanvasContentDiscoveryMentor extends Driver{
    Canvas canvas;
    ...
    public void PreviewForToolsTab(){
        try{
            ...
            new LoginUsingLTI().ltiLogin("37_1");// login as user instructor with mandate fields for Content Discovery screen
            ...
            Assert.fail("Exception in TC PreviewForToolsTab of class CanvasContentDiscoveryMentor", e);
        }
    ...
    public void PreviewForAssignmentsTab(){
        try{
            ...
            Assert.fail("Exception in TC PreviewForAssignmentsTab of class CanvasContentDiscoveryMentor", e);
        }
