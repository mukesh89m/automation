 ...
 */
public class MentorGAWithPolicyFourInStudentSide extends Driver {
    @Test(priority = 1, enabled = true)
    public void mentorGAWithPolicyFourInStudentSide() {
        ...
        try {
           ...
           new LoginUsingLTI().ltiLogin("36_1");//login as student
            ...
            new LoginUsingLTI().ltiLogin("36_1");//login as student
            new Assignment().submitAssignmentAsStudent(36); //submit assignment


            new LoginUsingLTI().ltiLogin("36");//login as instructor
            new Assignment().releaseGrades(36, "Release Grade for All");
            ...
            new LoginUsingLTI().ltiLogin("36");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(36); //provide grade to all question
            ...
            Assert.assertEquals(driver.findElement(By.xpath("//span[@title='Assignment_IT18_3611']")).isDisplayed(), true, " Student is not navigated to 'Assignment Summary' page");
        ...
        {
            Assert.fail("Exception in test case mentorGAWithPolicyFourInStudentSide of class MentorGAWithPolicyFourInStudentSide", e);
        }
    }
