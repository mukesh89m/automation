...
import com.snapwiz.selenium.tests.staf.edulastic.testcases.IT1.Epic46.MatchingTables;
...
/**
 * Created by pragya on 24-02-2015.
 */
public class AssignPointsMatchingTables extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsMatchingTables() {
        //Adding the points to MatchingTables question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 29;
            ...
            addMatchingTablesQuestion(dataIndex);
   ...
   Assert.assertEquals(listPage.getPoint().getText(), "4", "Point is not displaying as modified by instructor");
            ...
            Assert.fail("Exception in testcase 'addingPointsMatchingTables' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionMatchingTables() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("167","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionMatchingTables' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsMatchingTables(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsMatchingTables' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsMatchingTables(){
        try{String appendChar = "a";
            int dataIndex = 365;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsMatchingTables' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForMatchingTables(){
        try{String appendChar = "a";
            int dataIndex = 424;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForMatchingTables' in class 'AssignPoints'", e);
        }
    }


    public void addMatchingTablesQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            MatchingTables matchingTables = PageFactory.initElements(driver,MatchingTables.class);
            CreateAssignment createAssessment = PageFactory.initElements(driver, CreateAssignment.class);
            TLOListPage tloListPage = PageFactory.initElements(driver, TLOListPage.class);
            ...
            new Click().clickBycssselector("label[for='matrix-box-checkbox-btn-4']");//click on 4th checkbox
