 ...
 */
public class MentorAllowsCollaborationEnabledWithStudentToStudentSocialPolicy extends Driver{

    @Test
    public void mentorAllowsCollaborationEnabledWithStudentToStudentSocialPolicy()
    {
        try
        {
            String policyname = ReadTestData.readDataByTagName("", "policyname", "138");
            String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", "138");
            new Assignment().create(138);
            new Assignment().addQuestionsWithCustomizedQuestionText(138, "qtn-type-true-false-img", assessmentname, 3);

            new LoginUsingLTI().ltiLogin("138_1");//create a student1
            new LoginUsingLTI().ltiLogin("138_2");//create a student2

            new LoginUsingLTI().ltiLogin("138");//log in as Mentor
            new SetSocialPolicy().setSocialPolicy("138", "two"); //set Student to student social policy
            new Navigator().NavigateTo("Assignment Policies");//navigate to Assignment Policies
            new AssignmentPolicy().createAssignmentPolicy(policyname, "138 Policy description text", "1",null, false, "1", "", null, "", "", "");
            new Assignment().assignToStudent(138);

            new LoginUsingLTI().ltiLogin("138_1");//login as student1
            new Assignment().openAssignmentFromCourseStream("138");//open the assignment

            //TC row no. 138....9. Submit the first question..Student should navigate to next question
            ...
            //TC row no. 139 ... 10. Click on question dropdown to navigate the previous question..Discussion and Star tab should appear at the right side of the question preview page for first question
            ...
            //TC row no. 140 ..11. Click on "+New Discussion" button..Visual indicator of social policy 2 should not appear in the Discussion text box
            ...
            //TC row no. 141....12. Add a discussion in Discussion tab through "+New Discussion" button...Posted Discussion should appear under Discussion and Star tab only
            new Navigator().navigateToTab("Discussion");//discussion tab appears
            ...
            //TC row no. 142...13. Add a note in Star tab through "+New Note" button...Posted note should appear under Star tab only
            ...
            //TC row no. 143..""14. Attempt each question and Finish the assignment    15. Go to report page and click on question card for which the discussion and note were posted"
            //Posted discussion should be present under Discussion and Star tab
            new Assignment().submitAssignmentAsStudent(138);
            ...
            //TC row no. 144...Posted note should be present under Star tab
            ...
            new LoginUsingLTI().ltiLogin("138_2"); //login as student 2
            new Assignment().openAssignmentFromCourseStream("138");//open the assignment

            //TC row no. 145....17. Submit as student 2...Discussion posted by student 1 for question1 should appear under Discussion tab of student2
            new SelectAnswerAndSubmit().staticAssignment("A");//submit 1st question
            new StaticAssignmentSubmit().navigateFromQuestionDropdown("1");//navigate question 1
            ...
            //TC row no. 146..Note posted by student 1 should not appear under Star tab of student2
            ...
            //TC row no. 147..."18. Complete the assignment..19. Go to Course Stream"...Discussion posted by student1 should appear in Course Stream
            new Assignment().submitAssignmentAsStudent(138);//complete the assignment
            ...
            //TC row no. 148, 149..//20. Click on the jump-out icon of that posted discussion....Discussion posted by student 1 should appear under Discussion tab of student2
        ...
        {
            Assert.fail("Exception in test case mentorAllowsCollaborationEnabledWithStudentToStudentSocialPolicy in class MentorAllowsCollaborationEnabledWithStudentToStudentSocialPolicy.", e);
        }
    }
