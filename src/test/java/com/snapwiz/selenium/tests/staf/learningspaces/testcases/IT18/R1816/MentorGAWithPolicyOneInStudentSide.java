 ...
 */
public class MentorGAWithPolicyOneInStudentSide extends Driver{
    @Test(priority = 1, enabled = true)
    public void mentorGAWithPolicyOneInStudentSide() {
        ...
        try {
            ...
            String assignmentpolicyname = ReadTestData.readDataByTagName("", "assignmentpolicyname", "35");

            new LoginUsingLTI().ltiLogin("35_1");//login as student
            new LoginUsingLTI().ltiLogin("35");//login as instructor
            new Assignment().create(35);
            for(int i=0;i<11;i++)
                new Assignment().addQuestions(35,"truefalse","");
            new LoginUsingLTI().ltiLogin("35");//login as instructor
            ...
            new Assignment().assignToStudent(35);//assign to student

            new LoginUsingLTI().ltiLogin("35_1");//login as student
            new Assignment().submitAssignmentAsStudent(35); //submit assignment
            ...
            new WebDriverWait(driver,120).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='tooltip-label-subsection-wrapper']/span[2]")));
            ...
            new LoginUsingLTI().ltiLogin("35");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(35); //provide grade to all question
            ...
            Assert.assertEquals(driver.findElement(By.xpath("//span[@title='Assignment_IT18_35']")).isDisplayed(), true, " Student is not navigated to 'Assignment Summary' page");
        ...
        {
            Assert.fail("Exception in test case mentorGAWithPolicyOneInStudentSide of class MentorGAWithPolicyOneInStudentSide", e);
        }
    }
