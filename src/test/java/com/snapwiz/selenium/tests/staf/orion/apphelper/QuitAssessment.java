...
import com.snapwiz.selenium.tests.staf.orion.uihelper.TabClose;

public class QuitAssessment 
{
	private static Logger logger = Logger.getLogger("com.snapwiz.selenium.tests.staf.orion.apphelper.QuitAssessment");
	...
	public boolean quitTheAssesmentCompletlyAndStartTheSameAssesmentAgainForDiagnostic()
	{
		try
		{
			...
			new TopicOpen().topicOpen(card1topic1);
