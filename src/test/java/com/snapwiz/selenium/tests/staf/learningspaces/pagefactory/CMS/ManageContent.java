...
public class ManageContent {
    ...
    @FindBy(xpath = "//a[@title='Change Font Family']")
    ...
    @FindBy(className="palette-header")
    public WebElement langaugePalette_header;
    ...
    @FindBy(id = "qinstance")
    public WebElement qInstance;

    @FindBy(xpath = "//*[@id='literallyEqual']/following-sibling::label[@for='literallyEqual']" )
    public WebElement literallyEqualRadioLabel;

    @FindBy(xpath = "//*[@id='mathematicallyEqual']/following-sibling::label[@for='mathematicallyEqual']" )
    public WebElement mathematicallyEqualRadioLabel;

    @FindBy(xpath = "//*[@id='syntaxSettings']/h4[.='Comparison with student answer']" )
    public WebElement comparisonWithStudentAnswerHeader;

    @FindBy(id = "mathematicallyEqual" )
    public WebElement mathematicallyEqualRadio;

    @FindBy(id = "literallyEqual" )
    public WebElement literallyEqualRadio;

    @FindBy(id = "question-raw-content" )
    public WebElement  question_EditBox;

    @FindBy(id = "question-mp-raw-content-0" )
    public WebElement  multiPartQuestion_EditBox;

    @FindBy(id = "question-editor-cancel" )
    public WebElement questionEditorCancelLink;

    @FindBy(xpath = "//*[@id='collections-data-wrapper']/div[@class='viewport']//li[@id='assessment']")
    public List<WebElement> listAssociatedContent;

    @FindBy(id="answer_math_edit")
    public WebElement correctAnswerEdit;

    @FindBy(xpath="//*[@id='wirisEditorContainer']//input[contains(@class,'wrs_focusElement')]")
    public WebElement wrsEdit;

    @FindBy(xpath="//*[@id='wirisAnswerEditorContainer']//input[contains(@class,'wrs_focusElement')]")
    public WebElement wrsAnswerEdit;

    @FindBy(xpath="//*[@id='wiris-container-save-choice1']/span")
    public WebElement wrsSave;

    @FindBy(xpath="//*[@id='wiris-answer-container-save-choice1']/span")
    public WebElement wrsAnswerSave;


    @FindBy(xpath="//*[contains(@id,'mapleAcceptAns')]")
    public WebElement mapleAcceptAnswer;
    ...
    @FindBy(xpath = "//*[@class=\"redactor-comp\"]")
    public WebElement redactorComp;



    @FindBy(css = "a[class='re-icon re-matheditor redactor-btn-image']")
    public WebElement redactorToolbar_SquareRoot;

    @FindBy(xpath = "//*[@id='wirisEditorContainer']//button[@title='Square root']")
    public WebElement wrsDialog_ToolBar_SquareRoot;

    @FindBy(id="cms-notification-dialog")
    public WebElement notificationDialog;

    @FindBy(xpath = ".//*[@id='cms-notification-dialog']//div[@class='cms-notification-message-body-title']")
    public WebElement notificationTitle;

    @FindBy(xpath = "//*[@id='cms-notification-dialog']//span[contains(@class,'cms-notification-message-ignore-changes')]")
    public WebElement notificationSaveChangesYes;

    @FindBy(xpath = "//*[@id='cms-notification-dialog']//span[contains(@class,'cms-notification-message-back-to-question')]")
    public WebElement notificationSaveChangesCancel;

    @FindBy(id = "course-structure-tree-content")
    public WebElement courseStructureTree;

    @FindBy(id = "editor-delete-question-btn")
    public WebElement notificationQuestionDelete;

    @FindBy(className = "collection-assessment-name")
