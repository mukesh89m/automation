...
/**
 * Created by Mukkesh on 1/9/15.
 */
public class MentorEditAndSaveGradeForPolicyThree extends Driver {

    @Test(priority = 1, enabled = true)
    public void mentorEditAndSaveGradableAssignmentPolicyThree() {
        ...
        try {
            ...
            new Assignment().addQuestions(25, "essay", "");
            new Assignment().addQuestions(25, "essay", "");
            for(int i=0;i<9;i++)
                new Assignment().addQuestions(25,"truefalse","");
            new LoginUsingLTI().ltiLogin("25");//login as instructor
            ...
            new Assignment().assignToStudent(25);//assign to student

            new LoginUsingLTI().ltiLogin("25_1");//login as student
            new Assignment().submitAssignmentAsStudent(25); //submit assignment
            new LoginUsingLTI().ltiLogin("25");//login as instructor
            new Assignment().provideGradeToStudentForMultipleQuestions(25);
            ...
            new LoginUsingLTI().ltiLogin("25");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(26); //provide grade to all questions
           ...
           // Assert.assertNotEquals(classProficiencyReportByQuestion,classProficiencyReportByQuestion1,"Class Performance by Question is not updated");
            ...
            Assert.fail("Exception in test case mentorEditAndSaveGradeForGradableAssignmentPolicyTwo of class MentorEditAndSaveGradeForPolicyThree", e);
        }
    }
