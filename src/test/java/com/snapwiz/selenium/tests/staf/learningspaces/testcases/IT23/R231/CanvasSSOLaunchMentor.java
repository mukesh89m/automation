 ...
 */
public class CanvasSSOLaunchMentor extends Driver {
    WebDriver driver;
    Dashboard dashboard;
    Canvas canvas;
    ...
    public void instructorSSOLaunchWplsHomepage() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsHomepage of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplsChapter() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsChapter of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplseBook() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplseBook of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplsGradebook() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsGradebook of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplsCourseStream() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsCourseStream of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplsReports() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsReports of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplsPrepare() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsPrepare of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplsGradeRefresh() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsGradeRefresh of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplsnotes() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsnotes of class CanvasSSOLaunchMentor", e);
    ...
    public void instructorSSOLaunchWplsAssignments() {
        try {
            ...
            Assert.fail("Exception in TC instructorSSOLaunchWplsAssignments of class CanvasSSOLaunchMentor", e);
    ...
    public void guidParameterLaunch() {
        try {
            ...
            Assert.fail("Exception in TC guidParameterLaunch of class CanvasSSOLaunchMentor", e);
