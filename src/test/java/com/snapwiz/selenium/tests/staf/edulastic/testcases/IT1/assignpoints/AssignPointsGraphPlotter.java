 ...
 */
public class AssignPointsGraphPlotter extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsGraphPlotter() {
        //Adding the points to GraphPlotter question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 5011;
            ...
            addGraphPlotterQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsGraphPlotter' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionGraphPlotter() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("5151","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionGraphPlotter' in class 'AssignPoints'", e);
    ...
    public void gradedOnAssignmentSubNotToChangePointsGraphPlotter(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsGraphPlotter' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsGraphPlotter(){
        try{String appendChar = "a";
            int dataIndex = 5346;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsGraphPlotter' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForGraphPlotter(){
        try{String appendChar = "a";
            int dataIndex = 5404;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForGraphPlotter' in class 'AssignPoints'", e);
        }
    }


    public void addGraphPlotterQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addGraphPlotterQuestion' in class 'AssignPoints'", e);
        }
    }
