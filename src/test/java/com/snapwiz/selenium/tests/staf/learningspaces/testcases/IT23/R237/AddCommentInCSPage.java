...
/**
 * Created by mukesh on 23/9/15.
 */
public class AddCommentInCSPage extends Driver {
    ...
    public void languagePaletteAfterHighlightingText(){
        ...
        try {
            ...
            new TOCShow().tocHide();
            Thread.sleep(4000);
            WebElement element1 = (new WebDriverWait(driver,60)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("p[class='nonindent default']")));
            System.out.println(element1.getLocation().getX());
            System.out.println(element1.getLocation().getY());
            Actions actions = new Actions(driver);
                actions.moveToElement(element1, 60,70)
                        .clickAndHold()
                        .moveByOffset(150, 140)
                        .release()
                        .perform();
    ...
    public void addCommentToAnimationWidget(){
        ...
        try {
            ...
            courseStreamPage.langaugePalette_saveButton.click();//click on save
            Thread.sleep(2000);
            Assert.assertEquals(lessonPage.widgetComment_text.get(5).getText().trim(),"abc123","All the characters is not getting added to the question content area.");
    ...
    public void assignAnimationWidget(){
        ...
        try {
            ...
            new TOCShow().goToSearch("Animation");
            tocSearch.tocSearchList.get(0).click();
            ((JavascriptExecutor) driver).executeScript("arguments[0].click();", lessonPage.assignThisPop.get(6));
            lessonPage.assignThisText_link.click();
            ...
            //TC row no 23
            Assert.assertEquals(lessonPage.widgetComment_text.get(9).getText().trim(),"áÁéÉíÍñÑóÓúÚüÜ¡¿","All the characters is not getting added to the question content area.");
            ...
            Assert.assertEquals(new BooleanValue().presenceOfElement(25, By.id("language-palette-outer-wrapper")),false,"The Editor is not getting closed.");
            Assert.assertEquals(lessonPage.widgetComment_text.get(9).getText().trim(),"áÁéÉíÍñÑóÓúÚüÜ¡¿áááááÁÁÁÁÁéééééÉÉÉÉÉíííííÍÍÍÍÍñññññÑÑÑÑÑóóóóóÓÓÓÓÓúúúúúÚÚÚÚÚüüüüüÜÜÜÜÜ¡¡¡¡¡¿¿¿¿¿","All the characters is not getting added to the question content area.");
            ...
            courseStreamPage.langaugePalette_saveButton.click();//click on save
            Thread.sleep(2000);
            Assert.assertEquals(lessonPage.widgetComment_text.get(9).getText().trim(),"abc123","All the characters is not getting added to the question content area.");
