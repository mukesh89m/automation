 ...
 */
public class BrowseFunctionalityOfQuestionBankLS extends Driver {
    @Test(priority = 1, enabled = true)
    public void browseFunctionalityOfQuestionBank() {
        ...
        try {
            ...
            Assert.fail("Exception in TC browseFunctionalityOfQuestionBank of class BrowseFunctionalityOfQuestionBankLS", e);
        }
    }
    @Test(priority = 2, enabled = true)
    public void browseFunctionalityOfQuestionBankForMentor() {
        ...
        try {
            ...
            Assert.fail("Exception in TC browseFunctionalityOfQuestionBankForMentor of class BrowseFunctionalityOfQuestionBankLS", e);
        }
    ...
    public void allQuestionTypeFilterForBrowse() {
        try {
            ...
            Assert.fail("Exception in TC allQuestionTypeFilterForBrowse of class BrowseFunctionalityOfQuestionBankLS", e);
        }
    }
    ...
    public void allQuestionTypeFilterFunctionalityMentor() {
        try {
            ...
            NewAssignment newAssignment= PageFactory.initElements(driver,NewAssignment.class);
            int dataIndex=79;
            new LoginUsingLTI().ltiLogin("79"); //login as mentor
            new Navigator().NavigateTo("My Question Bank"); //navigate to question bank
            myQuestionBank.getCustomAssignmentButton().click(); //click on the custom assignment name
            newAssignment.browse_link.click(); //click on the browse link
            Thread.sleep(2000);
            ...
            Assert.fail("Exception in TC allQuestionTypeFilterFunctionalityMentor of class BrowseFunctionalityOfQuestionBankLS", e);
        }
    }
    ...
    public void newOrderQuestionInBrowser() {
        try {
            ...
            Assert.fail("Exception in TC newOrderQuestionInBrowser of class BrowseFunctionalityOfQuestionBankLS", e);
        }
    }
