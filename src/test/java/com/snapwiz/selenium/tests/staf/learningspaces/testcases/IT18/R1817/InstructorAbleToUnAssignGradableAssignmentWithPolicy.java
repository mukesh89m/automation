 ...
 */
public class InstructorAbleToUnAssignGradableAssignmentWithPolicy extends Driver{

    @Test(priority = 1, enabled = true)
    public void instructorAbleToUnAssignGradableAssignmentWithPolicy()
    {
        try
        {
            String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", "31");
            String assignmentpolicy = ReadTestData.readDataByTagName("", "assignmentpolicy", "31");
            ...
            new LoginUsingLTI().ltiLogin("31_1");		//login as student1
            new LoginUsingLTI().ltiLogin("31_2");    //login as student2
            ...
            new AssignmentPolicy().createAssignmentPolicy(assignmentpolicy, "63 Policy description", "2", null, false, "1", "", "Release explicitly by the instructor", "", "", "");
            new Assignment().assignToStudent(31);
            ...
            popUpFound = new BooleanValue().presenceOfElement(31, By.className("delete-notification"));
            ...
            classActivity = new BooleanValue().presenceOfElement(31, By.id("course-stream"));
            ...
            csEntry = new BooleanValue().presenceOfElement(31, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            ...
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            boolean csEntry1 = new BooleanValue().presenceOfElement(31, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            ...
            new LoginUsingLTI().ltiLogin("31");		//login a instructor
            new Assignment().assignToStudent(31);//assign once again
            ...
            new LoginUsingLTI().ltiLogin("31_1");		//login as student1
            new Assignment().submitAssignmentAsStudent(31);//submit the Assignment
        ...
        {
            Assert.fail("Exception in class InstructorAbleToUnAssignGradableAssignmentWithPolicy in method instructorAbleToUnAssignGradableAssignmentWithPolicy.", e);
