 ...
 */
public class AccessingWriteBoardEnabledQuestionsAsInstructor extends Driver{

    @Test(priority = 1, enabled = true)
    public void accessingWriteBoardEnabledQuestionsAsInstructor()
    {
        try{
            String appendChar = "a";
            int dataIndex = 131;
    ...
    public void accessingWriteBoardWhereStudentHasNotUsedWriteBoard()
    {
        try{
            String appendChar = "a";
            int dataIndex = 142;
