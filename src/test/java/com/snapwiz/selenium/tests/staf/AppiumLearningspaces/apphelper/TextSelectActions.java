        ...
        try
        {
            ...
            for (WebElement element1: allElements) {
                ...
                if(colorhex.length()>10)
                {
                    ...
                    if(rgb.equals(color)){
                        Thread.sleep(3000);
                        ((JavascriptExecutor)Driver.driver).executeScript("arguments[0].click();",element1);
                        // element1.click();
                        colorfound = true;
                        break;
                    }
            ...
            new com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelper.Navigator().navigateToTab("Fav");//navigate to Star tab
