 ...
 */
public class MentorDashboardTilesUpdateForDWAssignment extends Driver {
    ...
    public void dashboardTilesUpdateForGradableDWAssignment()
    {
        ...
        try {
            ...
            new DiscussionWidget().assignDiscussionWidgetWithDefaultClassSection(38);

            new LoginUsingLTI().ltiLogin("38_1");//login a student
            ...
            new LoginUsingLTI().ltiLogin("38"); //login as instructor
            new Assignment().releaseGrades(38, "Release Grade for All");
            ...
            Assert.fail("Exception in test case dashboardTilesUpdateForGradableDWAssignment of class MentorDashboardTilesUpdateForDWAssignment", e);
        }
    }
    ...
    public void dashboardTilesUpdateForNonGradableDWAssignment()
    {
        ...
        try {
            ...
            new LoginUsingLTI().ltiLogin("40_1");//login as student2
            new LoginUsingLTI().ltiLogin("39"); //login as instructor
            new Navigator().NavigateTo("e-Textbook");
            new TopicOpen().openLessonWithDiscussionWidget();//open chapter10.3
            new DiscussionWidget().assignDiscussionWidgetWithDefaultClassSection(39);
            ...
            new LoginUsingLTI().ltiLogin("39"); //login as instructor
            new Assignment().provideFeedback(39);//provide feedback

            new LoginUsingLTI().ltiLogin("40_1");//login a student 2
            new Navigator().NavigateTo("Assignments");	//navigate to Assignment
            new Click().clickByclassname("learning-activity-title"); //click on DW
            ...
            new LoginUsingLTI().ltiLogin("39"); //login as instructor
            new Assignment().provideFeedBackForMultipleQuestion(39, "This is a New FeedbackText");
            ...
            Assert.fail("Exception in test case dashboardTilesUpdateForNonGradableDWAssignment of class MentorDashboardTilesUpdateForDWAssignment", e);
        }
    }
