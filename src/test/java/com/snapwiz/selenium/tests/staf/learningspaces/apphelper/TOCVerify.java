...
public class TOCVerify  extends Driver
{   String tocvalue=null;
	...
	public String [] tocverify(int cardIndex)
	{
		try
		{
			...
			String chapterstatus = driver.findElement(By.className("chapter-heading")).getAttribute("class");
			if(chapterstatus.equals("chapter-heading"))
				driver.findElement(By.xpath("/html/body/div[3]/div/div/ul[2]/div/div[2]/div/li/div/div")).click();
			Thread.sleep(3000);
			if(cardIndex == 1)
			tocvalue = driver.findElement(By.xpath("/html/body/div[3]/div/div/ul[2]/div/div[2]/div/li/div/div[2]/ul")).getText();
			
			else
				tocvalue = driver.findElement(By.xpath("/html/body/div[3]/div/div/ul[2]/div/div[2]/div/li/div/div[2]/ul["+cardIndex+"]")).getText();
	...
	public void tocChapterVerify(int dataIndex)
	{
		try
		{
			...
			String chaptername;
			List<WebElement> chapters = driver.findElements(By.className("media__body"));
	...
	public void tocTopicValidate(int dataIndex,int cardIndex)
	{
		...
		WebDriver driver=Driver.getWebDriver();
			try
			{
				...
				Thread.sleep(3000);
				if(cardIndex == 1)
				tocvalue = driver.findElement(By.className("chapter-card")).getText();
				else
				{
					List<WebElement> topics = driver.findElements(By.className("topic-card"));
