 ...
 */
public class MentorAbleToUnAssignGradableAssignment extends Driver {

    @Test(priority = 1, enabled = true)
    public void mentorAbleToUnAssignGradableAssignment()
    {
        try
        {
            ...
            new LoginUsingLTI().ltiLogin("11_1");		//login as student1
            new LoginUsingLTI().ltiLogin("11_2");    //login as student2
            new LoginUsingLTI().ltiLogin("11");		//login a mentor
            ...
            popUpFound = new BooleanValue().presenceOfElement(11, By.className("delete-notification"));
            ...
            classActivity = new BooleanValue().presenceOfElement(11, By.id("course-stream"));
            ...
            csEntry = new BooleanValue().presenceOfElement(11, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            ...
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            boolean csEntry1 = new BooleanValue().presenceOfElement(11, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            ...
            new LoginUsingLTI().ltiLogin("11");		//login a mentor
            new Assignment().assignToStudent(11);//assign once again
            ...
            new LoginUsingLTI().ltiLogin("11_1");		//login as student1
            new Assignment().submitAssignmentAsStudent(11);//submit the Assignment
        ...
        {
            Assert.fail("Exception in class MentorAbleToUnAssignGradableAssignment in method mentorAbleToUnAssignGradableAssignment.", e);
        }
    }
