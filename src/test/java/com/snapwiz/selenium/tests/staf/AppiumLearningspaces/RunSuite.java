...
public final class RunSuite extends TestCase {	
	...
	public static TestSuite suite() {
	    TestSuite suite = new TestSuite();    
		 ...
		 //File file = new File("/opt/automation-test-framework/selenium/learningspaces/testsuite.ods");
		 File file = new File("/home/akansh/testsuite.ods");
	       ...
	       for(int i=0;i<data.size();i++)
	       {
	    	  String testcase = data.get(i);
	    	   ...
	    	   try
	    	   {
	    		   testcase = "com.snapwiz.selenium.tests.staf.learningspaces.testcases."+testcase;
