 ...
 */
public class MentorActiveTabForLS  extends Driver{
    ...
    public void activeTab() {
        try {
            ...
            Assert.fail("Exception in TC activeTAB of class ActiveForLS", e);
    ...
    public void activeTabForMoreThanTenClassSection() {
        try {
            ...
            Assert.fail("Exception in TC activeTabForMoreThanTenClassSection of class ActiveForLS", e);
    ...
    public void defaultTabHighLightedState() {
        try {
            ...
            Assert.fail("Exception in TC defaultTabHighLightedState of class ActiveForLS", e);
    ...
    public void ellipsesForAllThreeTab() {
        try {
            ...
            Assert.fail("Exception in TC ellipsesForAllThreeTab of class ActiveForLS", e);
    ...
    public void tooltipForAllThreeTab() {
        try {
            ...
            Assert.assertEquals(classSectionDropDown.classSectionName_list.get(0).getAttribute("title"), inActiveContext_title, "Complete class section is not displayed as a \"Tooltip\".");
