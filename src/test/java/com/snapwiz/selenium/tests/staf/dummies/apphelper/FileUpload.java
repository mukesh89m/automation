...
public class FileUpload {
	...
	private static Logger logger = Logger.getLogger("com.snapwiz.selenium.tests.staf.dummies.apphelper.FileUpload");
	...
	public void enterFileUploadText()
	{
		try
		{
			...
			{
				new com.snapwiz.selenium.tests.staf.dummies.apphelper.KeysSend().sendKeyBoardKeys(str);
			}
			else
			{
