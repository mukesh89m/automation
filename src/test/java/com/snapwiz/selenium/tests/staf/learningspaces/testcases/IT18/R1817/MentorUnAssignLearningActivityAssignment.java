 ...
 */
public class MentorUnAssignLearningActivityAssignment extends Driver {

    @Test(priority = 1, enabled = true)
    public void mentorUnAssignLearningActivityAssignment()
    {
        try
        {
            ...
            new LoginUsingLTI().ltiLogin("127_2");      //login as student2
            new LoginUsingLTI().ltiLogin("127");		//login as instructor
            new Navigator().NavigateTo("e-Textbook");
            new AssignLesson().assignAllLesson("127");  //assign all lesson
            ...
            assessmentFound = new BooleanValue().presenceOfElement(127, By.className("ls-assignment-name-block"));
            ...
            new LoginUsingLTI().ltiLogin("127");		//login as instructor
            new Navigator().NavigateTo("e-Textbook");
            new AssignLesson().assignAllLesson("127");  //assign all lesson again
        ...
        {
            Assert.fail("Exception in class MentorUnAssignLearningActivityAssignment in method mentorUnAssignLearningActivityAssignment.", e);
        }
    }
