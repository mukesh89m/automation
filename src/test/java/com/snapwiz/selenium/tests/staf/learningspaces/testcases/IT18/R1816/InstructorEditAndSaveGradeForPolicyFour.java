 ...
 */
public class InstructorEditAndSaveGradeForPolicyFour extends Driver {

    @Test(priority = 1, enabled = true)
    public void instructorEditAndSaveGradeForGradableAssignmentPolicyFour() {
        ...
        try {
            ...
            String assignmentpolicyname = ReadTestData.readDataByTagName("", "assignmentpolicyname", "171");

            new LoginUsingLTI().ltiLogin("171_1");//login as student
            ...
            new AssignmentPolicy().createAssignmentPolicy(assignmentpolicyname, "Policy description21", "2", null, false, "1", "", "", "", "", "");//policy4

            new Navigator().NavigateTo("Assignments");//navigate to Assignments
            new Assignment().assignToStudent(171);//assign to student

            new LoginUsingLTI().ltiLogin("171_1");//login as student
            new Assignment().submitAssignmentAsStudent(171); //submit assignment
            ...
            new LoginUsingLTI().ltiLogin("171");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(171); //provide grade to all questions
            ...
            //Expected 171 Chapter Proficiency' should be updated taking the changed grade for that assignment.
