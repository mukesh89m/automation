 ...
 */
public class AssignmentHavingFiveKStudent extends Driver {
    @Test(priority = 1)
    public void assignmentHavingFiveKStudent () {
        try {
            ...
            for(int i=1;i<=100;i++){
                ltiLogin("11",Integer.toString(i));//login as student
            }
            ...
            new Assignment().assignToStudent(10);//assign to student
            ...
            Assert.fail("Exception in TC assignmentHavingFiveKStudent of class AssignmentHavingFiveKStudent", e);
        }
