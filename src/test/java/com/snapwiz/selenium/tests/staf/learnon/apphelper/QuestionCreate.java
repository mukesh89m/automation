...
public class QuestionCreate {
	...
	public void saveQuestion(String learningobjective,String solutionText, String hintText, String useWriteBoard, String difficultylevel, String variationLevel, int dataIndex)
    {
        try {
            ...
            if(variationLevel != null)
			 {
            	...
            	new Click().clickBycssselector("option[value='Low']");
			 }
            new Click().clickbylinkText("Draft"); //click on Draft option
            new Click().clickbylinkText("Publish");//click on Publish option
            new Click().clickByid("saveQuestionDetails1");//click on save button
            Thread.sleep(2000);
        }
        catch (Exception e)
