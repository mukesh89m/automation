...
public class AccessingWriteBoardEnabledQuestionsInGradableAssignment extends Driver{

    @Test(priority = 1, enabled = true)
    public void accessingWriteBoardEnabledQuestionsInGradableAssignment()
    {
        try
        {
            String appendChar = "a";
        ...
        {
            Assert.fail("Exception in testcase accessingWriteboardEnabledQuestionsInGradableAssignment in class AccessingWriteboardEnabledQuestionsInGradableAssignment.", e);
        }
    }

    @Test(priority = 2, enabled = true)
    public void accessingWriteBoardEnabledQuestionsInGradableAssignmentOtherQuestions()
    {
        try
        {
            String appendChar = "a";
        ...
        {
            Assert.fail("Exception in testcase accessingWriteBoardEnabledQuestionsInGradableAssignmentOtherQuestions in class AccessingWriteboardEnabledQuestionsInGradableAssignment.", e);
        }
    }
}
