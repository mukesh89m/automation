...
public class InstructorShowPerformanceReport
{
	@Test
	public void instructorShowPerformanceReport()
	{
		try
		{
			Driver.startDriver();
			String totalnumberofquestion=ReadTestData.readDataByTagName("InstructorShowPerformanceReport", "totalnoofquestion", "960");
			new LoginUsingLTI().ltiLogin("960");//login as student 
			...
			new LoginUsingLTI().ltiLogin("9601");//login as instructor
