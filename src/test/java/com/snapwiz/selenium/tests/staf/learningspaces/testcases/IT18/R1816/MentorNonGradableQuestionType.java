 ...
 */
public class MentorNonGradableQuestionType extends Driver{
    ...
    public void nonGradableQuestionType()
    {
        ...
        try {
            ...
            String questiontext = ReadTestData.readDataByTagName("", "questiontext", "18");
            ...
            new LoginUsingLTI().ltiLogin("18");//login as instructor
            new Assignment().assignToStudent(18); //assign to the student

            new LoginUsingLTI().ltiLogin("18_1"); //login as student
            new Assignment().submitAssignmentAsStudent(18); //submit assignment
            ...
            provideFeedback(18,"This is a FeedbackText"); //provide feedback to the student
            new Assignment().releaseGrades(18, "Release Feedback for All");//click on the release feedback
            ...
            new WebDriverWait(driver, 1200).until(ExpectedConditions.presenceOfElementLocated(By.className("resource-title")));
            ...
            provideFeedback(18,"This is a New FeedbackText");//provide feedback to student
            new LoginUsingLTI().ltiLogin("18_1"); //login as student
    ...
    public void forGradableDWAssignment()
    {
        ...
        try {
            ...
            new DiscussionWidget().assignDiscussionWidgetWithDefaultClassSection(23);
    ...
    public void forNonGradableDWAssignment()
    {
        ...
        try {
            ...
            new LoginUsingLTI().ltiLogin("24_1");//login as student1
            ...
            new LoginUsingLTI().ltiLogin("24"); //login as instructor
            new Assignment().provideFeedBackForMultipleQuestion(24, "This is a New FeedbackText");
            ...
            new LoginUsingLTI().ltiLogin("24"); //login as instructor
            new Assignment().provideFeedBackForMultipleQuestion(24, "This is a New FeedbackText1");
