 ...
 */
public class MentorGAWithoutPolicyInStudentSide extends Driver {

       @Test(priority = 1, enabled = true)
       public void mentorGAWithoutPolicyInStudentSide() {
            ...
            try {
                ...
                new LoginUsingLTI().ltiLogin("37_1");//login as student
                new LoginUsingLTI().ltiLogin("37"); //login as instructor
                new Assignment().create(37); //create assignment
                for (int i = 0; i < 11; i++)
                    new Assignment().addQuestions(37, "truefalse", "");
                new LoginUsingLTI().ltiLogin("37");//login as instructor
                new Assignment().assignToStudent(37); //assign to the student
                new LoginUsingLTI().ltiLogin("37_1"); //login as student
                new Assignment().submitAssignmentAsStudent(37); //submit assignment
                /*new LoginUsingLTI().ltiLogin("37");//login as instructor
                new Assignment().releaseGrades(37, "Release Grade for All");*/
                ...
                new LoginUsingLTI().ltiLogin("37");//login as instructor
                new Assignment().updateGradeAfterGradeRelease(37); //provide grade to all question
                ...
                Assert.assertEquals(driver.findElement(By.xpath("//span[@title='Assignment_IT18_37']")).isDisplayed(), true, " Student is not navigated to 'Assignment Summary' page");
                ...
                Assert.fail("Exception in test case mentorGAWithoutPolicyInStudentSide of class MentorGAWithoutPolicyInStudentSide", e);
            }
        }
    }
