...
public class LessonPage {
    ...
    public WebElement forAssignmentName;
    ...
    public WebElement assign_button1;
    ...
    @FindBy(xpath = "//a[starts-with(@class, 'btn btn--primary btn--large btn--submit')]") //a[class='btn btn--primary btn--large btn--submit']
    ...
    @FindBy(xpath = "//*[contains(@id,'sbSelector')]")
    public  WebElement classSectionName;

    @FindBy(xpath = "//*[@class='submit-assignment-content']/span")
    public WebElement assignButton;

    @FindBy(className = "closebutton")
    public WebElement close_Button;

    @FindBy(xpath = "//a[@class='ls-resource-show-assign-this-block']")
    public  WebElement arrow_resourceTab;

    @FindBy(css = "i[class='ls-right-section-sprites ls--right-star-icon-resource']")
    public WebElement bookmarkResource;

    @FindBy(css = "input[class='toc-sprite search-course-stream ui-autocomplete-input']")
    public  WebElement searchETextBook;

    @FindBy(id="due-date")
    public WebElement due_date;

    @FindBy(id="due-time")
    public WebElement due_time;

    @FindBy(css= "a[title='Next']")
    public  WebElement dueDateNext;

    @FindBy(css = "//a[text()='9']")
    public WebElement selectDueDate;

    @FindBy(xpath = "//span[@title='Add to Activity']")
    public WebElement addToActivity;

    @FindBy(className = "ls-assignment-show-assign-this-block")
    public List<WebElement> assignmentArrow;

    @FindBy(css = "span[class='ls-right-tab-hover-sprite folder-cycle-bg']")
    public WebElement assignmentArrowOpen;

    @FindBy(className = "al-diag-test-title")
    public WebElement practiceTestHeader;

    @FindBy(className = "al-quit-diag-test-icon")
    public WebElement quitPractice_Test;

    @FindBy(className = "ls-practice-test-view-report")
    public WebElement viewReport_link;

    @FindBy(className = "ls-adaptive-practice-test-close")
    public WebElement backToLastSession_link;

    @FindBy(className = "resource-title")
    public WebElement resource_title;

    @FindBy(css = "span[class='resource-title practice-assignment-title']")
    public WebElement resource_titleFromCousreStream;

    @FindBy(css = "div[class='ls-assign-this-sprite assign-this-lesson-bg']")
    public WebElement assign_lesson_icon;

    @FindBy(css="a[class='lesson-bookmark-sprite-img bookmark-lesson']")
    public WebElement bookmarkLessonIcon;

    @FindBy(css="div[aria-controls='tab-assignments']")
    public WebElement assignmentTab;

    @FindBy(className="toc-assignment-ellipsis")
    public WebElement TOCassignmentName;

    @FindBy(className = "ptext")
    public List<WebElement> highlightOption;

    @FindBy(xpath = "//span[starts-with(@class,'highlighted annotation-')]")
    public WebElement highlightText;

    @FindBy(className = "widget-close")
    public WebElement widgetClose_icon;

    public By widgetClose=By.className("widget-close");

    @FindBy(id="sec-intro")
    public WebElement introduction_Text;

    @FindBy(id = "ls-right-post-comment-link")
    public WebElement widget;

    @FindBy(className = "ls-stream-post__comment-text")
    public WebElement comment;

    @FindBy(css = "a[class='right-post-like widget-like-thumbs-up']")
    public WebElement unlike_Link;

    @FindBy(xpath = "//span[@mode='tabswitch']")
    public  List<WebElement> yesNo;

    @FindBy(id = "close-assignment")
    public WebElement closeAssignment;

    @FindBy(className = "continue-assessment-yes")
    public WebElement yesLinkOnRobo;

    @FindBy(css = "span[class='ls-assign-this-sprite-right-tab assign-resource-bg']")
    public WebElement assignThis_Link;

    @FindBy(css = "div[class='dw-add-perspective-block redactor_editor']")
    public WebElement your_perspective;
}
