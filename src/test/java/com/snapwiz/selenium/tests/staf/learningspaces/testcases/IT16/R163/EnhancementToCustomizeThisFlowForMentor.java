 ...
 */
public class EnhancementToCustomizeThisFlowForMentor extends Driver{
    ...
    public void enhancementToCustomizeThisFlow()
    {
        try
        {
            ...
            String name = ReadTestData.readDataByTagName("", "name", "71");
            String searchquestion = ReadTestData.readDataByTagName("", "searchquestion", "71");
            String customassignmentname = ReadTestData.readDataByTagName("", "customassignmentname", "71");
            String name2 = ReadTestData.readDataByTagName("", "name2", "71");
            String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", "71");
            String questiontext = ReadTestData.readDataByTagName("", "questiontext", "71");
            new Assignment().create(71);//create assignment
            new Assignment().addQuestionsWithCustomizedQuestionText(71, "qtn-type-true-false-img", assessmentname, 3);

            new LoginUsingLTI().ltiLogin("71");    //login as mentor
            new Navigator().NavigateTo("Question Banks");

            //TC row no. 71...3. Click on "Customize This" link, present below any assessment...mentor should navigate to New Assignment tab where the questions of existing assignment should be present
            ...
            if(!tab.equals("New Assignment"))
                Assert.fail("Click on \"Customize This\" link, mentor does not navigate to New Assignment tab.");
            ...
            new AssignLesson().selectQuestionForCustomAssignment("71");
            Thread.sleep(3000);
            driver.findElement(By.cssSelector("span.save-for-later-text")).click();//click on Save For Later
            ...
            //TC row no. 79...10. Click on 'Assign This' link and assign the assignment...mentor should navigate to Assignment Summary page
            new AssignLesson().Assigncustomeassignemnt(71);
            String url = driver.getCurrentUrl();
            if(!url.contains("assignment"))
                Assert.fail("After assigning a custom assignment the mentor doesn't navigate to Assignment page.");
            ...
            */
            ...
            Thread.sleep(2000);
            new AssignLesson().selectQuestionForCustomAssignment("71");//select two question
            Thread.sleep(1000);
            new Click().clickByid("ls-ins-assignment-name");//click on Name field
            Thread.sleep(1000);
            ...
            //TC row no. 84...19. Fill the entries and click on assign button...Customize tab should be closed as soon as mentor clicks on assign button
            new AssignLesson().assignCustomAssignment(71);
            ...
            */
             ...
             */
            new CreateCustomAssignment().createCustomAssignment(questiontext, "71");
            driver.findElement(By.cssSelector("span.save-for-later-text")).click();//click on Save For Later
