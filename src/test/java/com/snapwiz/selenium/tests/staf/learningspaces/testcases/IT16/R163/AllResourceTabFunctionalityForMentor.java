 ...
 */
public class AllResourceTabFunctionalityForMentor extends Driver{
    ...
    public void allResourceTabFunctionality()
    {
        try
        {
            ...
            new LoginUsingLTI().ltiLogin("23");    //login as mentor
    ...
    public void uploadAndDeleteResource()
    {
        try
        {
            ...
            String resourcesname1 = ReadTestData.readDataByTagName("", "resourcesname", "33");
            new LoginUsingLTI().ltiLogin("33_1");    //create a student
            new LoginUsingLTI().ltiLogin("33");    //login as mentor
            new UploadResources().uploadResources("33", true, false, true);//upload resource
            Thread.sleep(5000);
            //TC row no. 33...Ordering of items in the “My Resources” tab should follow the latest one at the top.
            String resourceTitle = driver.findElement(By.className("resource-title")).getText();
            if(!resourceTitle.contains(resourcesname1))
                Assert.fail("Newly added resource is not adding at the top of \"My Resources\" page.");
            ...
            //TC row no. 37..."13. Upload the new resource again...14. Assign the Resource"...mentor should get navigated to Assignment Summary page
            new UploadResources().uploadResources("33", true, false, true);//upload resource
            new AssignLesson().assignResourceFromMyResources(33);
            String url = driver.getCurrentUrl();
            if(!url.contains("assignment"))
                Assert.fail("mentor does not navigated to Assignment Summary page after assigning a resource from \"My Resources\".");
            ...
            if(!assignment.contains("posted an assignment."))
                Assert.fail("mentor assigns a resource from \"My Resources\" and its not visible to students.");
            ...
            if(assignment1 != 2)
                Assert.fail("After assigning resource, the mentor is unable to assign the resource again.");
