 ...
 */
public class InstructorAbleToUnAssignGradableAssignment extends Driver{

    @Test(priority = 1, enabled = true)
    public void instructorAbleToUnAssignGradableAssignment()
    {
        try
        {
            ...
            new LoginUsingLTI().ltiLogin("10_1");		//login as student1
            new LoginUsingLTI().ltiLogin("10_2");    //login as student2
            new LoginUsingLTI().ltiLogin("10");		//login a instructor
            ...
            popUpFound = new BooleanValue().presenceOfElement(10, By.className("delete-notification"));
            ...
            classActivity = new BooleanValue().presenceOfElement(10, By.id("course-stream"));
            ...
            csEntry = new BooleanValue().presenceOfElement(10, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
           ...
           // Expected: The assignment entry in the assignment tab should be removed for that assignment.
            ...
            new Navigator().NavigateTo("Course Stream");//navigate to Course Stream
            boolean csEntry1 = new BooleanValue().presenceOfElement(10, By.cssSelector("li[class='ls-media ls-stream-post ls-stream-post--question']"));
            ...
            new LoginUsingLTI().ltiLogin("10");		//login a instructor
            new Assignment().assignToStudent(10);//assign once again
            ...
            new LoginUsingLTI().ltiLogin("10_1");		//login as student1
            new Assignment().submitAssignmentAsStudent(10);//submit the Assignment
        ...
        {
            Assert.fail("Exception in class InstructorAbleToUnAssignGradableAssignment in method instructorAbleToUnAssignGradableAssignment.", e);
        }
    }
