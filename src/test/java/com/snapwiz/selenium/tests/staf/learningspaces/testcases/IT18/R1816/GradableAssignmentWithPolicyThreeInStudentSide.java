 ...
 */
public class GradableAssignmentWithPolicyThreeInStudentSide extends Driver{
    @Test(priority = 1, enabled = true)
    public void gradableAssignmentWithPolicyThreeInStudentSide() {
        ...
        try {
            ...
            new Assignment().addQuestions(294, "essay", "");
            new Assignment().addQuestions(294, "essay", "");
            for(int i=0;i<9;i++)
                new Assignment().addQuestions(294,"truefalse","");
            new LoginUsingLTI().ltiLogin("294");//login as instructor
            ...
            new Assignment().assignToStudent(294);//assign to student

            new LoginUsingLTI().ltiLogin("294_1");//login as student
            new Assignment().submitAssignmentAsStudent(294); //submit assignment
            new LoginUsingLTI().ltiLogin("294");//login as instructor
            new Assignment().provideGradeToStudentForMultipleQuestions(294);
            ...
            new LoginUsingLTI().ltiLogin("294");//login as instructor
            new Assignment().updateGradeAfterGradeRelease(295); //provide grade to all question
            ...
            Assert.assertEquals(driver.findElement(By.xpath("//span[@title='(shor)  Assignment_IT18_294']")).isDisplayed(), true, " Student is not navigated to 'Assignment Summary' page");
        ...
        {
            Assert.fail("Exception in test case radableAssignmentWithPolicyThreeInStudentSide of class GradableAssignmentWithPolicyThreeInStudentSide", e);
        }
    }
