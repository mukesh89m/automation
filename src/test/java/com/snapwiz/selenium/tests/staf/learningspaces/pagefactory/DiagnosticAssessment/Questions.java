package com.snapwiz.selenium.tests.staf.learningspaces.pagefactory.DiagnosticAssessment;
...
public class Questions {
    ...
    @FindBy(css = "span[class='continue-diagnostic-test practice-assignment']")
    public WebElement goToMyAssignment_Link;
