 ...
 */
public class AssignPointsSentenceResponse extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsSentenceResponse() {
        //Adding the points to SentenceResponse question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 23;
            ...
            addSentenceResponseQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsSentenceResponse' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionSentenceResponse() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("163","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionSentenceResponse' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 3,enabled = true)
    public void gradedOnAssignmentSubNotToChangePointsSentenceResponse(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsSentenceResponse' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsSentenceResponse(){
        try{String appendChar = "a";
            int dataIndex = 363;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsSentenceResponse' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForSentenceResponse(){
        try{String appendChar = "a";
            int dataIndex = 421;
            ...
            addSentenceResponseQuestion(422);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("4");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            trueFalse.getButton_review().click();//Click on review button
            listPage.getButton_addMore().click();//Click on add more button
            addSentenceResponseQuestion(423);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("5");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForSentenceResponse' in class 'AssignPoints'", e);
        }
    }



    public void addSentenceResponseQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addSentenceResponseQuestion' in class 'AssignPoints'", e);
