 ...
 */
public class AssignPointsTrueFalse extends Driver {


    @Test(priority = 1, enabled = true)
    public void addingPointsTrueFalse() {
        //Adding the points to true false question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 14;
            ...
            addTrueFalseQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsTrueFalse' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 2, enabled = true)
    public void pointAssignedToParticularQuestionTrueFalse() {
        try {
            String appendChar = "a";
            ...
            tloListPage.getButtonGrade2_create().click();//Click on create button
            questionTypesPage.getIcon_TrueFalseType().click();//Click on True False question type
            ...
            trueFalse.getTextField_EnterQuestionText().click();//Click on question text box
            trueFalse.getTextField_EnterQuestionText().sendKeys("True False " + questiontext);//Type the question
            trueFalse.getButton_True().click();//Click on answer option A
            trueFalse.getPoint_editor().click();//Click on point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("2");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            selectExistingAssessmentToCustomize(dataIndex);//Select the existing assessment to customize
            listPage.getArrowLink().click();//Click on arrow
            ...
            new Assignment().selectOwner("172","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionTrueFalse' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 3,enabled = true)
    public void gradedOnAssignmentSubNotToChangePoints(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePoints' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePoints(){
        try{String appendChar = "a";
            int dataIndex = 361;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePoints' in class 'AssignPoints'", e);
        }
    }


    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestion(){
        try{String appendChar = "a";
            int dataIndex = 414;
            ...
            assessments.getButton_newAssessment().click();//Click on new assessment
            createAssessment.getButton_create().click();//Click on create new assessment
            addTrueFalseQuestion(dataIndex);//Add  a question
            trueFalse.getSave_button().click();//Click on save button
            new WebDriverWait(driver,20).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[text()='Saved.']")));
            trueFalse.getButton_review().click();//Click on review button
            listPage.getButton_addMore().click();//Click on add more button
            addTrueFalseQuestion(451);
            trueFalse.getPoint_editor().click();//Click on Point editor
            trueFalse.getPoint_textbox().clear();//Remove the point
            trueFalse.getPoint_textbox().sendKeys("4");//Enter the point
            trueFalse.getSave_button().click();//Click on save button
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestion' in class 'AssignPoints'", e);
        }
    }


    public void addTrueFalseQuestion(int index) {
        try {
            ...
            Assert.fail("Exception in testcase 'addTrueFalseQuestion' in class 'AssignPoints'", e);

        }
    }


    public void selectExistingAssessmentToCustomize(int dataIndex) {
        try {
            String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(dataIndex));
            ...
            if(selectgrade!=null)
            {
                ...
                Select select=new Select(driver.findElement(By.xpath("//div[@id='lsm-createAssignment-grade-dropDown']/select")));
                select.selectByVisibleText(selectgrade);//select a grade
            }

            int index = 0;
            new ExplicitWait().explicitWaitByCssSelector("div[class='assessment-name ellipsis']", 30);
            ...
            for (WebElement assignment : allAssignment) {
                if (assignment.getText().trim().equals(assessmentname)) {
                    new Click().clickByListClassName("as-customize-button",index);
                    break;
                } else
            ...
            Assert.fail("Exception in testcase 'selectExistingAssessmentToCustomize' in class 'AssignPoints'", e);
