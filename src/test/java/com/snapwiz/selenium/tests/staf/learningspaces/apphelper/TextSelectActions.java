...
public class TextSelectActions extends Driver{
    ...
    public void verifyHighlight(String paragraphId,String className,String index)
    {
        try
        {
            ...
            List<WebElement> ptexts = driver.findElements(By.xpath("//*[starts-with(@class, 'ptext')]"));
            ...
            List<WebElement> allElements = driver.findElements(By.xpath("//*[starts-with(@class, 'pcolor highlightcolor')]"));
    ...
    public void verifyAddNote(String paragraphId,String className,String index)
    {
        try
        {
            ...
            List<WebElement> allElements = driver.findElements(By.xpath("//*[starts-with(@class, 'pcolor notecolor')]"));
            for (WebElement element1: allElements) {
    ...
    public void verifyAddDiscussion(String paragraphId,String className,String index)
    {
        try
        {
            ...
            List<WebElement> allElements = driver.findElements(By.xpath("//*[starts-with(@class, 'pcolor discussioncolor')]"));
            for (WebElement element1: allElements) {
    ...
    public void highLightText(String color,String paragraphId)
    {
        try
        {
            ...
            Thread.sleep(5000);
            List<WebElement> highligtedtext = driver.findElements(By.xpath("//*[starts-with(@class, 'highlighted annotation')]"));
    ...
    public void addNote(String color,String paragraphId)
    {
        try
        {
            ...
            WebElement textbox = driver.findElement(By.className("editnote-text"));
            WebElement submitbutton = driver.findElement(By.id("editnote-submit-INTERIM"));
            ...
            driver.findElement(By.className("editnote-text")).sendKeys(noterandomstring);
            JavascriptExecutor jsx = (JavascriptExecutor)driver;
            jsx.executeScript("window.scrollBy(0,50)", "");
            WebElement submitnotebutton = driver.findElement(By.cssSelector("button[class='editnote-button editnote-submit']"));
            ...
            if(!noterandomstring.equals(note.getText()))
    ...
    public void addDiscussion(String color,String paragraphId,int moveToOffset,int moveByOffset)
    {
        ...
        try
        {
            boolean defaultgreen = true;
            if(color.length()>0)
                color = color.toLowerCase();//set if color is passed while calling this method
            else
                color = "#b6d68c";//color is hardcoded because discussion will be always in green color
            boolean colorfound = false;
            WebElement element = (new WebDriverWait(driver,10)).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("p[class='nonindent default']")));
            ...
            //validating text pop up, submit and cancel buttons
            WebElement textbox = driver.findElement(By.className("editdiscussion-text"));
            WebElement submitbutton = driver.findElement(By.id("editdiscussion-submit-INTERIM"));
            ...
            driver.findElement(By.className("editdiscussion-text")).sendKeys(discussionstring);
            //new KeysSend().sendKeyBoardKeys(discussionstring);
            //new KeysSend().sendKeyBoardKeys("`^");
            JavascriptExecutor jsx = (JavascriptExecutor)driver;
            jsx.executeScript("window.scrollBy(0,50)", "");
            Thread.sleep(2000);
            WebElement submitbutton1 = driver.findElement(By.cssSelector("button[class='editdiscussion-button editdiscussion-submit']"));
            submitbutton1.click();
            Thread.sleep(2000);
            //Validating right side panel
            ...
            String username = driver.findElement(By.cssSelector("a[class='ls-right-user-name ellipsis']")).getText();
            if(!username.equals("You"))//for self posted discussion "You" is displayed not the user's name
            ...
            if(defaultgreen == false)  Assert.fail("The default Add Discussion color is not green.");
        }
        catch(Exception e)
        {
