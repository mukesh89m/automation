 ...
 */
public class MentorInactiveTabForLS extends Driver {
    ...
    public void inActiveTab() {
        try {
         ...
         /*   String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
            ...
            Assert.fail("Exception in TC inActiveTAB of class InactiveTabForLS", e);
    ...
    public void inactiveTabForMoreThanTenClassSection() {
        try {
          ...
          /*  String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
            ...
            Assert.fail("Exception in TC inactiveTabForMoreThanTenClassSection of class InactiveTabForLS", e);
    ...
    public void finished() {
        try {
          ...
          /*  String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
            ...
            Assert.fail("Exception in TC finished of class InactiveTabForLS", e);
    ...
    public void finishedTabForMoreThanTenClassSection() {
        try {
           ...
           /* String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
            ...
            Assert.fail("Exception in TC finishedTabForMoreThanTenClassSection of class InactiveTabForLS", e);
    ...
    public void activeToInactiveAndFinished() {
        ...
        /*    String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
            ...
            classSectionDropDown.classSection_DropDown.click(); //click on the class section dropdown
            Assert.assertEquals(classSectionDropDown.emptyClassSectionMsg.get(0).getText(), "You are currently viewing the only class in this status.", "\"Default message \"There are no class sections in this tab\" not displayed.");
            classSectionDropDown.inactive_tab.click(); //click on the inactive class section Tab
            Assert.assertEquals(classSectionDropDown.classSectionName_list.get(1).getAttribute("title").trim(), context_title, "Classsection which was Active previously should be seen here.");
            classSectionDropDown.finished_tab.click(); //click on the inactive class section Tab
            Assert.assertEquals(classSectionDropDown.emptyClassSectionMsg.get(1).getText(), "There are no classes in this tab.", "\"Default message \"There are no class sections in this tab\" not displayed.");
            ...
            classSectionDropDown.classSection_DropDown.click(); //click on the class section dropdown
            Assert.assertEquals(classSectionDropDown.emptyClassSectionMsg.get(0).getText(), "You are currently viewing the only class in this status.", "Classsection which was Active is not  Removed here.");
            classSectionDropDown.inactive_tab.click(); //click on the inactive class section Tab
            Assert.assertEquals(classSectionDropDown.emptyClassSectionMsg.get(1).getText(), "There are no classes in this tab.", "\"Default message \"There are no class sections in this tab\" not displayed.");
            classSectionDropDown.finished_tab.click(); //click on the inactive class section Tab
            Assert.assertEquals(classSectionDropDown.classSectionName_list.get(1).getAttribute("title").trim(), context_title, "Classsection which was Active previously should be seen here.");
            ...
            Assert.fail("Exception in TC activeToInactiveAndFinished of class InactiveTabForLS", e);
    ...
    public void inactiveToActiveAndFinished() {
        try {
         ...
         /*   String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
            ...
            classSectionDropDown.classSection_DropDown.click(); //click on the class section dropdown
            Assert.assertEquals(classSectionDropDown.emptyClassSectionMsg.get(0).getText(), "You are currently viewing the only class in this status.", "Classsection which was InActive previously should not be seen here.");
            classSectionDropDown.active_tab.click(); //click on the active class section Tab
            Thread.sleep(2000);
            ...
            Assert.fail("Exception in TC inactiveToActiveAndFinished of class InactiveTabForLS", e);
