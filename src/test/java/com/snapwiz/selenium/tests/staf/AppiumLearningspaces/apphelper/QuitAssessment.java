...
import com.snapwiz.selenium.tests.staf.AppiumLearningspaces.uihelper.TabClose;

public class QuitAssessment 
{
	private static Logger logger = Logger.getLogger("com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelper.QuitAssessment");
	...
	public boolean quitTheAssesmentCompletlyAndStartTheSameAssesmentAgainForDiagnostic()
	{
		try
		{
			...
			Thread.sleep(5000);
			new TOCShow().tocShow();
			new com.snapwiz.selenium.tests.staf.AppiumLearningspaces.apphelper.DiagnosticTest().startTest(2);
