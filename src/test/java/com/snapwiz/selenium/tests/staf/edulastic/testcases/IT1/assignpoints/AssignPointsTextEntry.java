 ...
 */
public class AssignPointsTextEntry extends Driver {

    @Test(priority = 1, enabled = true)
    public void addingPointsTextEntry() {
        //Adding the points to TextEntry question explicitly
        try {
            String appendChar = "a";
            int dataIndex = 1032;
            ...
            addTextEntryQuestion(dataIndex);
            ...
            Assert.fail("Exception in testcase 'addingPointsTextEntry' in class 'AssignPoints'", e);
    ...
    public void pointAssignedToParticularQuestionTextEntry() {
        try {
            String appendChar = "a";
            ...
            new Assignment().selectOwner("1170","Me");
            ...
            Assert.fail("Exception in testcase 'pointAssignedToParticularQuestionTextEntry' in class 'AssignPoints'", e);

        }
    }

    @Test(priority = 3,enabled = true)
    public void gradedOnAssignmentSubNotToChangePointsTextEntry(){
        try{String appendChar = "a";
            ...
            Assert.fail("Exception in testcase 'gradedOnAssignmentSubNotToChangePointsTextEntry' in class 'AssignPoints'", e);
        }
    }
    ...
    public void gradedExplicitByTeacherNotToChangePointsTextEntry(){
        try{String appendChar = "a";
            int dataIndex = 1365;
            ...
            Assert.fail("Exception in testcase 'gradedExplicitByTeacherNotToChangePointsTextEntry' in class 'AssignPoints'", e);
        }
    }

    @Test(priority = 5,enabled = true)
    public void pointsVerifyMultipleQuestionForTextEntry(){
        try{String appendChar = "a";
            int dataIndex = 1424;
            ...
            Assert.fail("Exception in testcase 'pointsVerifyMultipleQuestionForTextEntry' in class 'AssignPoints'", e);
        }
    }

    public void addTextEntryQuestion(int index){
        try{String assessmentname = ReadTestData.readDataByTagName("", "assessmentname", Integer.toString(index));
            ...
            Assert.fail("Exception in testcase 'addTextEntryQuestion' in class 'AssignPoints'", e);
        }
    }
