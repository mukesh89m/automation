 ...
 */
public class StudentShouldBeAbleToBrowseForVariousElements extends Driver{
    ...
    public void toCheckTheBrowseResultsBasedOnAFilterSelected() {
        try {
            ...
            Assert.fail("Exception in test case toCheckTheBrowseResultsBasedOnAFilterSelected in class StudentShouldBeAbleToBrowseForVariousElements", e);
        }
    }
    ...
    public void theFormatForEveryCardEntryForAChapterLevelBrowseResults() {
        try {
            //tc row no 84
            TocSearch tocSearch = PageFactory.initElements(driver, TocSearch.class);
            new LoginUsingLTI().ltiLogin("84");//login as student
            new TOCShow().chaptertree();//click on toc
            tocSearch.getTocSearch().click();//click on toc search
            ...
            Assert.fail("Exception in test case theFormatForEveryCardEntryForAChapterLevelBrowseResults in class StudentShouldBeAbleToBrowseForVariousElements", e);
        }
    }
    ...
    public void theUserShouldBeAbleToBrowseTheResultsAsPerTheSelectedImageFilterIcon() {
        try {
            //tc row no 92
            TocSearch tocSearch = PageFactory.initElements(driver, TocSearch.class);
            new LoginUsingLTI().ltiLogin("92");//login as student
            new TOCShow().chaptertree();//click on toc
            tocSearch.getTocSearch().click();//click on toc search
            tocSearch.getTocSearch().sendKeys("mitosis ", Keys.chord(Keys.SHIFT, Keys.NUMPAD9) + "also, karyokinesis)");
            tocSearch.getSearch_Icon().click();//click on search
            ...
            Assert.fail("Exception in test case theUserShouldBeAbleToBrowseTheResultsAsPerTheSelectedImageFilterIcon in class StudentShouldBeAbleToBrowseForVariousElements", e);
        }
    }
    ...
    public void theUserShouldBeAbleToBrowseTheResultsAsPerTheSelectedLessonFilterIcon() {
        try {
            ...
            Assert.fail("Exception in test case theUserShouldBeAbleToBrowseTheResultsAsPerTheSelectedLessonFilterIcon in class StudentShouldBeAbleToBrowseForVariousElements", e);
        }
    }
    ...
    public void theUserShouldBeAbleToBrowseTheResultsAsPerTheSelectedDiscussionFilterIcon() {
        try {
            //tc row no 108
            TocSearch tocSearch = PageFactory.initElements(driver, TocSearch.class);
            new LoginUsingLTI().ltiLogin("108");//login as student
            new TOCShow().chaptertree();//click on toc
            tocSearch.getTocSearch().click();//click on toc search
            ...
            Assert.fail("Exception in test case theUserShouldBeAbleToBrowseTheResultsAsPerTheSelectedDiscussionFilterIcon in class StudentShouldBeAbleToBrowseForVariousElements", e);
        }
    }
    ...
    public void theUserShouldBeAbleToBrowseTheResultsAsPerTheSelectedAnimationFilterIcon() {
        try {
            //tc row no 113
            TocSearch tocSearch = PageFactory.initElements(driver, TocSearch.class);
            new LoginUsingLTI().ltiLogin("113");//login as student
            new TOCShow().chaptertree();//click on toc
            tocSearch.getTocSearch().click();//click on toc search
            tocSearch.getTocSearch().sendKeys("mitosis ", Keys.chord(Keys.SHIFT, Keys.NUMPAD9) + "also, karyokinesis)");
            tocSearch.getSearch_Icon().click();//click on search
            ...
            Assert.fail("Exception in test case theUserShouldBeAbleToBrowseTheResultsAsPerTheSelectedAnimationFilterIcon in class StudentShouldBeAbleToBrowseForVariousElements", e);
        }
    }
    ...
    public void theUserMustBeAbleToToggleBetweenFilters() {
        try {
            //tc row no 117
            TocSearch tocSearch = PageFactory.initElements(driver, TocSearch.class);
            new LoginUsingLTI().ltiLogin("117");//login as student
            new TOCShow().chaptertree();//click on toc
            tocSearch.getTocSearch().click();//click on toc search
            tocSearch.getTocSearch().sendKeys("mitosis ", Keys.chord(Keys.SHIFT, Keys.NUMPAD9) + "also, karyokinesis)");
            tocSearch.getSearch_Icon().click();//click on search
            ...
            Assert.fail("Exception in test case theUserMustBeAbleToToggleBetweenFilters in class StudentShouldBeAbleToBrowseForVariousElements", e);
        }
    }
