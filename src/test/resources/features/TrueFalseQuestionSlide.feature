Feature: Add True False Question slide to lesson
  1.2.4 As a user (author), I should be able to add True False Question slide to the micro lesson
  Scenario: Add True or false Question slide in lesson
    ...
    When I click on the "True or false" Question slide
    Then I should see "Add Question" as header label
    When I click on Add To Slide Button for verifying warning message
    Then I should see warning message "Question title should not be empty" for True False Question
  ...
  Scenario Outline: Add question text using text editor
    ...
    And   I enter the required details in the Question slide for True false question type
    Then  I should see the True False question text font style according "<tag>"
